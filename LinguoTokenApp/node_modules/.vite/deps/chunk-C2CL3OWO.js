...
function WalletTypeRowButton(props) {
  return (0, import_jsx_runtime2.jsx)(Button, { fullWidth: true, variant: "outline", style: {
    ...
    props.onClick();
  }, disabled: props.disabled, children: (0, import_jsx_runtime2.jsxs)(Container, { flex: "row", gap: "sm", center: "y", color: "accentText", children: [(0, import_jsx_runtime2.jsx)(Img, { client: props.client, src: props.icon, width: iconSize.md, height: iconSize.md, loading: "eager", style: {
...
function CountrySelector({ countryCode, setCountryCode }) {
  ...
  const { data: supportedCountries } = useQuery({
    ...
    queryFn: async () => {
      const { supportedSmsCountries } = await import("./supported-sms-countries-XZCIHEJF.js");
...
var ConnectWalletSocialOptions = (props) => {
  ...
  }, title: locale.phonePlaceholder, disabled: props.disabled })), passKeyEnabled && (0, import_jsx_runtime6.jsx)(WalletTypeRowButton, { client: props.client, icon: passkeyIcon, onClick: () => {
    handlePassKeyLogin();
  }, title: locale.passkey, disabled: props.disabled }), guestEnabled && (0, import_jsx_runtime6.jsx)(WalletTypeRowButton, { client: props.client, icon: getWalletIcon("guest"), onClick: () => {
    handleGuestLogin();
  }, title: locale.loginAsGuest, disabled: props.disabled }), props.isLinking && (0, import_jsx_runtime6.jsx)(WalletTypeRowButton, { client: props.client, icon: getWalletIcon(""), onClick: () => {
    handleWalletLogin();
...
async function getInAppWalletLocale(localeId) {
  switch (localeId) {
    case "es_ES":
      return (await import("./es-ZFBWMH2H.js")).default;
    case "ja_JP":
      return (await import("./ja-BQLXJXJJ.js")).default;
    case "tl_PH":
      return (await import("./tl-UC36C6HF.js")).default;
    case "vi_VN":
      return (await import("./vi-TXYBIZMI.js")).default;
    case "de_DE":
      return (await import("./de-D2RKVYJC.js")).default;
    case "ko_KR":
      return (await import("./kr-R73SB7WJ.js")).default;
    case "fr_FR":
      return (await import("./fr-LAXC7AN7.js")).default;
    default:
      return (await import("./en-QTPMQXQU.js")).default;
  }
}
...
//# sourceMappingURL=chunk-C2CL3OWO.js.map
