...
async function connectSmartWallet(wallet, connectionOptions, creationOptions) {
  ...
  const factoryAddress = options.factoryAddress ?? getDefaultAccountFactory((_a = creationOptions.overrides) == null ? void 0 : _a.entrypointAddress);
  ...
  const accountAddress = await predictAddress({
    ...
    predictAddressOverride: (_b = options.overrides) == null ? void 0 : _b.predictAddress,
    accountSalt: (_c = options.overrides) == null ? void 0 : _c.accountSalt,
    accountAddress: (_d = options.overrides) == null ? void 0 : _d.accountAddress
  ...
  const account = {
    ...
    async signMessage({ message }) {
      const [{ isContractDeployed: isContractDeployed2 }, { readContract: readContract2 }, { encodeAbiParameters: encodeAbiParameters2 }, { hashMessage }, { checkContractWalletSignature }] = await Promise.all([
        import("./is-contract-deployed-7LWTTLAY.js"),
        import("./read-contract-4WF22K7X.js"),
        import("./encodeAbiParameters-USWXLUHF.js"),
        import("./hashMessage-O4NW72JF.js"),
        import("./checkContractWalletSignature-YA77OVAE.js")
      ]);
    ...
    async signTypedData(_typedData) {
      ...
      const [{ isContractDeployed: isContractDeployed2 }, { readContract: readContract2 }, { encodeAbiParameters: encodeAbiParameters2 }, { checkContractWalletSignedTypedData }] = await Promise.all([
        ...
        import("./read-contract-4WF22K7X.js"),
        import("./encodeAbiParameters-USWXLUHF.js"),
        import("./checkContractWalletSignedTypedData-UNSWA5RA.js")
      ]);
...
async function _deployAccount(args) {
  ...
  const [{ sendTransaction }, { prepareTransaction }] = await Promise.all([
    import("./send-transaction-KKTTIMID.js"),
    import("./prepare-transaction-Y53J5XQH.js")
  ]);
...
//# sourceMappingURL=chunk-VEZWTSHB.js.map
