...
var QueriesObserver = (_a10 = class extends Subscribable {
  ...
  getOptimisticResult(queries, combine2) {
    ...
    return [
      result,
      (r) => {
        return __privateMethod(this, _QueriesObserver_instances, combineResult_fn).call(this, r ?? result, combine2);
      },
      () => {
...
}, _client2 = new WeakMap(), _result = new WeakMap(), _queries2 = new WeakMap(), _options = new WeakMap(), _observers2 = new WeakMap(), _combinedResult = new WeakMap(), _lastCombine = new WeakMap(), _lastResult = new WeakMap(), _QueriesObserver_instances = new WeakSet(), combineResult_fn = function(input, combine2) {
  if (combine2) {
...
function WalletImage(props) {
  ...
  if (image) {
    return (0, import_jsx_runtime9.jsx)(Img, { src: image, width: props.size, height: props.size, loading: "eager", client: props.client, style: {
      borderRadius: radius.md,
      ...props.style
    } });
  }
  return (0, import_jsx_runtime9.jsx)(WalletImageQuery, { id: props.id, size: props.size, client: props.client });
}
function WalletImageQuery(props) {
  const walletImage = useWalletImage(props.id);
  if (walletImage.isFetched && !walletImage.data) {
    return (0, import_jsx_runtime9.jsx)(Img, { client: props.client, src: genericWalletIcon, width: props.size, height: props.size });
  }
  return (0, import_jsx_runtime9.jsx)(Img, { client: props.client, src: walletImage.isLoading ? void 0 : walletImage.data, fallbackImage: genericWalletIcon, width: props.size, height: props.size, loading: "eager", style: {
    borderRadius: radius.md
  } });
}
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-L4FY5QXN.js.map
