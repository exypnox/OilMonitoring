...
function smartWallet(createOptions) {
  ...
  const _smartWallet = {
    ...
    autoConnect: async (options) => {
      const { connectSmartWallet } = await import("./smart-YBUG2RD5.js");
    ...
    disconnect: async () => {
      account = void 0;
      chain = void 0;
      const { disconnectSmartWallet } = await import("./smart-YBUG2RD5.js");
...
//# sourceMappingURL=chunk-AUVKPJDE.js.map
