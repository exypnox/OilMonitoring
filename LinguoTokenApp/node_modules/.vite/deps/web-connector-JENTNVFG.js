  ...
  async getAccount() {
    ...
    const _signTransaction = async (tx) => {
      ...
      const transaction = {
        ...
        nonce: tx.nonce ? toHex(tx.nonce) : toHex(await import("./eth_getTransactionCount-YDA67EFQ.js").then(({ eth_getTransactionCount }) => eth_getTransactionCount(rpcRequest, {
...
var InAppWebConnector = class {
  ...
  async passkeyAuth(args) {
    const { PasskeyWebClient } = await import("./passkeys-5DKGFAJQ.js");
...
//# sourceMappingURL=web-connector-JENTNVFG.js.map
