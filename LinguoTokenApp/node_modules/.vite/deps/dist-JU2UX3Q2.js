  ...
  "node_modules/@coinbase/wallet-sdk/dist/core/error/serialize.js"(exports) {
    ...
    function getErrorObject(error) {
      ...
      if (typeof error === "string") {
        ...
        const code = (_a = error.errorCode) !== null && _a !== void 0 ? _a : message.match(/(denied|rejected)/i) ? constants_1.standardErrorCodes.provider.userRejectedRequest : void 0;
...
var require_interface = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/core/provider/interface.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ProviderEventEmitter = void 0;
    var eventemitter3_1 = require_eventemitter3();
    var ProviderEventEmitter = class extends eventemitter3_1.EventEmitter {
    };
...
var require_ScopedLocalStorage = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/core/storage/ScopedLocalStorage.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function keccakP(s3, rounds = 24) {
      ...
      for (let round = 24 - rounds; round < 24; round++) {
        for (let x3 = 0; x3 < 10; x3++)
          B3[x3] = s3[x3] ^ s3[x3 + 10] ^ s3[x3 + 20] ^ s3[x3 + 30] ^ s3[x3 + 40];
        ...
        for (let y3 = 0; y3 < 50; y3 += 10) {
          for (let x3 = 0; x3 < 10; x3++)
            B3[x3] = s3[y3 + x3];
          for (let x3 = 0; x3 < 10; x3++)
            s3[y3 + x3] ^= ~B3[(x3 + 2) % 10] & B3[(x3 + 4) % 10];
        }
...
var require_sha256 = __commonJS({
  "node_modules/@noble/hashes/sha256.js"(exports) {
    ...
    var SHA256 = class extends _md_js_1.HashMD {
      ...
      get() {
        const { A: A3, B: B3, C: C3, D: D3, E: E2, F: F3, G: G2, H: H2 } = this;
        return [A3, B3, C3, D3, E2, F3, G2, H2];
      }
      // prettier-ignore
      set(A3, B3, C3, D3, E2, F3, G2, H2) {
        this.A = A3 | 0;
        this.B = B3 | 0;
        this.C = C3 | 0;
        this.D = D3 | 0;
      ...
      process(view, offset) {
        ...
        G2 = G2 + this.G | 0;
        H2 = H2 + this.H | 0;
        this.set(A3, B3, C3, D3, E2, F3, G2, H2);
      }
      roundClean() {
        SHA256_W.fill(0);
      }
  ...
  "node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/type/WalletLinkSession.js"(exports) {
    ...
    var WalletLinkSession = class _WalletLinkSession {
      ...
      static create(storage) {
        ...
        return new _WalletLinkSession(storage, id, secret).save();
      }
      static load(storage) {
...
var require_web = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/util/web.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_CoinbaseWalletProvider = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/CoinbaseWalletProvider.js"(exports) {
    ...
    var ScopedLocalStorage_1 = require_ScopedLocalStorage();
    var util_2 = require_util();
    var CoinbaseWalletProvider = class extends interface_1.ProviderEventEmitter {
      constructor(_a) {
          ...
          if (!this.signer) {
            switch (args.method) {
              ...
              case "net_version":
                return 1;
              case "eth_chainId":
                return (0, util_2.hexStringFromNumber)(1);
              default: {
...
*/
//# sourceMappingURL=dist-JU2UX3Q2.js.map
