...
var f2 = "generic";
var ot = `${_}bundler`;
var h = { DEFAULT_CHAIN_CHANGED: "default_chain_changed" };
...
var g2 = (r, t) => {
  ...
  if (j2) for (var e of j2(t)) ut.call(t, e) && R(r, e, t[e]);
  return r;
};
...
function T2(r) {
  ...
  for (const [a, c2] of Object.entries(r)) {
    const m3 = Oe(a) ? [a] : c2.chains, I = c2.methods || [], B = c2.events || [], V = c2.rpcMap || {}, v3 = Dn(a);
    n[v3] = lt(g2(g2({}, n[v3]), c2), { chains: N(m3, (t = n[v3]) == null ? void 0 : t.chains), methods: N(I, (e = n[v3]) == null ? void 0 : e.methods), events: N(B, (s = n[v3]) == null ? void 0 : s.events), rpcMap: g2(g2({}, V), (i = n[v3]) == null ? void 0 : i.rpcMap) });
  }
  return n;
}
function vt(r) {
...
var ft = class {
  ...
  setDefaultChain(t, e) {
    this.httpProviders[t] || this.setHttpProvider(t, e), this.chainId = t, this.events.emit(h.DEFAULT_CHAIN_CHANGED, `${this.name}:${t}`);
  }
  getAccounts() {
  ...
  createHttpProvider(t, e) {
    const s = e || p2(t, this.namespace, this.client.core.projectId);
...
var $t = class {
  ...
  setDefaultChain(t, e) {
    this.httpProviders[t] || this.setHttpProvider(parseInt(t), e), this.chainId = parseInt(t), this.events.emit(h.DEFAULT_CHAIN_CHANGED, `${this.name}:${t}`);
  }
  requestAccounts() {
    return this.getAccounts();
  }
  ...
  createHttpProvider(t, e) {
    const s = e || p2(`${this.name}:${t}`, this.namespace, this.client.core.projectId);
    if (!s) throw new Error(`No RPC url provided for chainId: ${t}`);
    return new o(new f(s, o3("disableProviderPing")));
  }
  setHttpProvider(t, e) {
  ...
  async handleSwitchChain(t) {
    ...
    else if (this.namespace.methods.includes("wallet_switchEthereumChain")) await this.client.request({ topic: t.topic, request: { method: t.request.method, params: [{ chainId: i }] }, chainId: (s = this.namespace.chains) == null ? void 0 : s[0] }), this.setDefaultChain(`${n}`);
  ...
  async getCapabilities(t) {
    ...
    if (c2 != null && c2[n]) return c2 == null ? void 0 : c2[n];
...
var Ht = class {
  ...
  setDefaultChain(t, e) {
    this.httpProviders[t] || this.setHttpProvider(t, e), this.chainId = t, this.events.emit(h.DEFAULT_CHAIN_CHANGED, `${this.name}:${this.chainId}`);
  }
  getAccounts() {
    const t = this.namespace.accounts;
    return t ? [...new Set(t.filter((e) => e.split(":")[1] === this.chainId.toString()).map((e) => e.split(":")[2]))] : [];
...
var Et = class {
  ...
  setDefaultChain(t, e) {
    ...
    this.chainId = t, this.events.emit(h.DEFAULT_CHAIN_CHANGED, `${this.name}:${this.chainId}`);
  }
  getDefaultChain() {
    if (this.chainId) return this.chainId;
    if (this.namespace.defaultChain) return this.namespace.defaultChain;
...
var Ot = class {
  ...
  setDefaultChain(t, e) {
    if (this.chainId = t, !this.httpProviders[t]) {
      const s = e || p2(`${this.name}:${t}`, this.namespace);
      if (!s) throw new Error(`No RPC url provided for chainId: ${t}`);
      this.setHttpProvider(t, s);
    }
    this.events.emit(h.DEFAULT_CHAIN_CHANGED, `${this.name}:${this.chainId}`);
  }
  getAccounts() {
    const t = this.namespace.accounts;
    return t ? t.filter((e) => e.split(":")[1] === this.chainId.toString()).map((e) => e.split(":")[2]) || [] : [];
...
var C = class _C {
  ...
  async authenticate(t, e) {
    ...
    if (this.session = n.session, this.session) {
      ...
      this.namespaces = b(this.namespaces, a), this.persist("namespaces", this.namespaces), this.onConnect();
    }
    return n;
  }
  on(t, e) {
  ...
  async pair(t) {
    ...
    do {
      ...
      s && (this.uri = s, this.events.emit("display_uri", s)), await i().then((n) => {
        ...
        this.namespaces = b(this.namespaces, a), this.persist("namespaces", this.namespaces);
      }).catch((n) => {
    ...
    E2("client", this.client), E2("events", this.events), E2("disableProviderPing", this.disableProviderPing), t.forEach((e) => {
      ...
      switch (e) {
        ...
        case "near":
          ...
          break;
        default:
          this.rpcProviders[f2] ? this.rpcProviders[f2].updateNamespace(a) : this.rpcProviders[f2] = new qt({ namespace: a });
      }
    });
  }
  registerEventListeners() {
    ...
    this.client.on("session_ping", (t) => {
      ...
      if (s.name === "accountsChanged") {
        ...
        const i = e.chainId, n = e.event.data, a = Dn(i), c2 = H(i) !== H(n) ? `${a}:${H(n)}` : i;
    ...
    }), this.on(h.DEFAULT_CHAIN_CHANGED, (t) => {
  ...
  validateChain(t) {
    ...
    if (e && !Object.keys(this.namespaces || {}).map((a) => Dn(a)).includes(e)) throw new Error(`Namespace '${e}' is not configured. Please call connect() first with namespace config.`);
    if (e && s) return [e, s];
  ...
  persist(t, e) {
    this.client.core.storage.setItem(`${D}/${t}`, e);
  }
  async getFromStore(t) {
    return await this.client.core.storage.getItem(`${D}/${t}`);
  }
};
var Ut = C;
...
var p3 = (r, t) => {
  for (var s in t || (t = {})) U4.call(t, s) && O2(r, s, t[s]);
  if (M2) for (var s of M2(t)) Q.call(t, s) && O2(r, s, t[s]);
  return r;
};
...
function L4(r) {
  ...
  if (!L(t)) throw new Error("Invalid chains");
  ...
  if (!s && !o4 && !e && !(h2 != null && h2.length) && !(d2 != null && d2.length)) return { required: t.length ? a : void 0 };
...
var C2 = class _C {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? m2(this.rpc.chains) : m2(this.rpc.optionalChains), this.signer = await Ut.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storageOptions: t.storageOptions, customStoragePrefix: t.customStoragePrefix, telemetryEnabled: t.telemetryEnabled }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s;
      try {
        const { WalletConnectModal: i } = await import("./dist-WDRLOEH3.js");
        s = i;
      } catch {
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=index.es-27IVFXOP.js.map
