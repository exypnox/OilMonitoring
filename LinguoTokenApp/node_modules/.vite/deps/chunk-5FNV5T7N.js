...
async function getNFTAsset(options) {
  ...
  switch (true) {
    case erc721: {
      const { getNFT } = await import("./getNFT-CQ3WD2NB.js");
      return getNFT(options);
    }
    case erc1155: {
      const { getNFT } = await import("./getNFT-H2XZ7N6Q.js");
      return getNFT(options);
    }
    default: {
...
//# sourceMappingURL=chunk-5FNV5T7N.js.map
