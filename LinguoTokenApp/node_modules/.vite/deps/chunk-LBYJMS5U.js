import {
  isERC1155,
  isERC721
} from "./chunk-GLBYL7RU.js";
import {
  EcosystemWalletConnectUI_default
} from "./chunk-QXXSC2MA.js";
import {
  AccentFailIcon,
  AnyWalletConnectUI,
  PoweredByThirdweb,
...
} from "./chunk-C2CL3OWO.js";
import {
  WalletLogoSpinner
} from "./chunk-WYREE2T7.js";
import {
  Fuse,
  useDebouncedValue,
  useShowMore
} from "./chunk-KK5SZCV6.js";
import {
  Input,
  Label,
  Spinner,
...
import {
  ...
  useWalletBalance,
  useWalletInfo
} from "./chunk-L4FY5QXN.js";
import {
  getNFT
} from "./chunk-RIDX3423.js";
import {
  getNFT as getNFT2
} from "./chunk-JBJHUT4N.js";
import {
  __assign,
  __rest,
  __spreadArray
...
} from "./chunk-3FEINVDM.js";
import {
  isInAppWallet
} from "./chunk-BI5B4BS4.js";
import {
  socialAuthOptions
} from "./chunk-AVNSVLSO.js";
import {
  resolveArweaveScheme
} from "./chunk-FTGVVEWF.js";
import {
  require_jsx_runtime
} from "./chunk-DOUTYWKU.js";
import {
  createWallet,
  isMobile
...
import {
  createStore,
  getTransactionStore
} from "./chunk-HH2NFLAA.js";
import {
  getGasPrice
} from "./chunk-FVFXS5GY.js";
import {
  encode
} from "./chunk-NVBBE2QQ.js";
import {
  resolveScheme
} from "./chunk-KLXH3ZM6.js";
import {
  polygon
} from "./chunk-MMHJMUKU.js";
import {
  ethereum
} from "./chunk-4JVIGEVQ.js";
import {
  transfer
  ...
  const loginMutation = useMutation({
    ...
    mutationFn: async () => {
      ...
      const [payload, { signLoginPayload }] = await Promise.all([
        ...
        import("./sign-login-payload-LCRTGPFE.js")
      ]);
      if (payload.chain_id) {
  ...
  useQueries({
    queries: wallets.filter((w) => w.id === COINBASE || w.id === "inApp" || isEcosystemWallet(w.id)).map((w) => ({
      ...
      queryFn: async () => {
        ...
        switch (true) {
          case COINBASE === w.id: {
            const { getCoinbaseWebProvider } = await import("./coinbaseWebSDK-LFPR2EZ4.js");
            await getCoinbaseWebProvider(w.getConfig());
            return true;
          }
          case "inApp" === w.id: {
            const [{ InAppWebConnector }, { getOrCreateInAppWalletConnector }] = await Promise.all([
              import("./web-connector-JENTNVFG.js"),
              import("./in-app-core-A6XKTPSK.js")
            ]);
...
async function getConnectLocale(localeId) {
  switch (localeId) {
    case "es_ES": {
      return (await import("./es-LM6II5LU.js")).default;
    }
    case "ja_JP": {
      return (await import("./ja-YV7BKDJV.js")).default;
    }
    case "tl_PH": {
      return (await import("./tl-U7PSLIT6.js")).default;
    }
    case "vi_VN": {
      return (await import("./vi-HHVLDNUA.js")).default;
    }
    case "de_DE": {
      return (await import("./de-OLTO57PS.js")).default;
    }
    case "ko_KR": {
      return (await import("./kr-DT2UIBD2.js")).default;
    }
    case "fr_FR": {
      return (await import("./fr-YE5BQUN2.js")).default;
    }
    default: {
      return (await import("./en-UVPCGLBU.js")).default;
    }
  }
}
...
function FiatSteps(props) {
  ...
  return (0, import_jsx_runtime42.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime42.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), (0, import_jsx_runtime42.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime42.jsx)(PaymentStep, { title: (0, import_jsx_runtime42.jsxs)(Text, { color: "primaryText", size: "md", children: ["Get", " ", (0, import_jsx_runtime42.jsx)(TokenSymbol, { token: onRampToken, chain: onRampChain, size: "md", inline: true }), " ", "with ", props.partialQuote.fromCurrencySymbol] }), step: 1, from: {
    ...
    url: `${(_j = onRampExplorers.explorers[0]) == null ? void 0 : _j.url}/tx/${onRampTxHash}`
  ...
  } : void 0 }), isPartialSuccess && props.status && props.status.status !== "NOT_FOUND" && props.status.source && props.status.destination && (0, import_jsx_runtime42.jsxs)(import_jsx_runtime42.Fragment, { children: [(0, import_jsx_runtime42.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime42.jsxs)(Text, { color: "danger", size: "sm", center: true, children: ["Expected ", (_l = props.status.source) == null ? void 0 : _l.token.symbol, ", Got", " ", (_m = props.status.destination) == null ? void 0 : _m.token.symbol, " instead"] }), (0, import_jsx_runtime42.jsx)(Spacer, { y: "sm" })] }), showContinueBtn && (0, import_jsx_runtime42.jsxs)(import_jsx_runtime42.Fragment, { children: [(0, import_jsx_runtime42.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime42.jsx)(Button, { variant: "accent", onClick: props.onContinue, fullWidth: true, children: "Continue" })] })] });
}
...
function SwapTxDetailsTable(props) {
  ...
  if (isTransfer) {
    return (0, import_jsx_runtime45.jsx)("div", { children: ((_d = (_c = fromChainExplorers.explorers) == null ? void 0 : _c[0]) == null ? void 0 : _d.url) && sourceTxHash && (0, import_jsx_runtime45.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${fromChainExplorers.explorers[0].url}/tx/${sourceTxHash}`, target: "_blank", gap: "xs", style: {
      fontSize: fontSize.sm,
      padding: spacing.sm
  ...
  return (0, import_jsx_runtime45.jsxs)("div", { children: [isPartialSuccess && gotToken ? (
    ...
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime45.jsx)(Text, { children: "Send to" }), (0, import_jsx_runtime45.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime45.jsx)(Text, { color: "primaryText", size: "sm", children: shortenAddress(uiData.toAddress) }) })] })] }), lineSpacer, ((_f = (_e = fromChainExplorers.explorers) == null ? void 0 : _e[0]) == null ? void 0 : _f.url) && sourceTxHash && (0, import_jsx_runtime45.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${fromChainExplorers.explorers[0].url}/tx/${sourceTxHash}`, target: "_blank", gap: "xs", style: {
    fontSize: fontSize.sm,
    padding: spacing.sm
  }, children: ["View on ", fromChainName.name, " Explorer", (0, import_jsx_runtime45.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] }), destinationTxHash && sourceTxHash !== destinationTxHash && ((_h = (_g = toChainExplorers == null ? void 0 : toChainExplorers.explorers) == null ? void 0 : _g[0]) == null ? void 0 : _h.url) && (0, import_jsx_runtime45.jsxs)(import_jsx_runtime45.Fragment, { children: [(0, import_jsx_runtime45.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime45.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${toChainExplorers.explorers[0].url}/tx/${destinationTxHash}`, target: "_blank", gap: "xs", style: {
    fontSize: fontSize.sm,
    padding: spacing.sm
...
function TransactionButton(props) {
  ...
  if (props.explorerUrl) {
    return (0, import_jsx_runtime52.jsx)("a", { href: `${props.explorerUrl}/tx/${props.hash}`, target: "_blank", rel: "noreferrer", children: content });
  }
  return content;
}
...
function TransactionsScreen(props) {
  ...
  ], selected: activeTab, onSelect: setActiveTab, children: [activeTab === "Purchases" && (0, import_jsx_runtime53.jsx)(PayTxHistoryList, { client: props.client, onSelectTx: setSelectedTx }), activeTab === "Transactions" && (0, import_jsx_runtime53.jsx)(WalletTransactionHistory, { locale: props.locale, client: props.client, address: payer.account.address })] })] }), (0, import_jsx_runtime53.jsx)(Line, {}), (0, import_jsx_runtime53.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime53.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${(_a = chainExplorers.explorers[0]) == null ? void 0 : _a.url}/address/${activeAccount == null ? void 0 : activeAccount.address}`, target: "_blank", as: "a", gap: "xs", style: {
    textDecoration: "none",
    color: "inherit"
...
var OutlineWalletIcon = (props) => {
  return (0, import_jsx_runtime54.jsxs)("svg", { width: props.size, height: props.size, viewBox: "0 0 24 24", role: "presentation", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [(0, import_jsx_runtime54.jsx)("path", { d: "M19 7V4C19 3.73478 18.8946 3.48043 18.7071 3.29289C18.5196 3.10536 18.2652 3 18 3H5C4.46957 3 3.96086 3.21071 3.58579 3.58579C3.21071 3.96086 3 4.46957 3 5C3 5.53043 3.21071 6.03914 3.58579 6.41421C3.96086 6.78929 4.46957 7 5 7H20C20.2652 7 20.5196 7.10536 20.7071 7.29289C20.8946 7.48043 21 7.73478 21 8V12M21 12H18C17.4696 12 16.9609 12.2107 16.5858 12.5858C16.2107 12.9609 16 13.4696 16 14C16 14.5304 16.2107 15.0391 16.5858 15.4142C16.9609 15.7893 17.4696 16 18 16H21C21.2652 16 21.5196 15.8946 21.7071 15.7071C21.8946 15.5196 22 15.2652 22 15V13C22 12.7348 21.8946 12.4804 21.7071 12.2929C21.5196 12.1054 21.2652 12 21 12Z", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime54.jsx)("path", { d: "M3 5V19C3 19.5304 3.21071 20.0391 3.58579 20.4142C3.96086 20.7893 4.46957 21 5 21H20C20.2652 21 20.5196 20.8946 20.7071 20.7071C20.8946 20.5196 21 20.2652 21 20V16", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/LazyBuyScreen.js
var import_jsx_runtime55 = __toESM(require_jsx_runtime(), 1);
var import_react34 = __toESM(require_react(), 1);
var BuyScreen = (0, import_react34.lazy)(() => import("./BuyScreen-L4E7KCJG.js"));
function LazyBuyScreen(props) {
  return (0, import_jsx_runtime55.jsx)(import_react34.Suspense, { fallback: (0, import_jsx_runtime55.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime55.jsx)(BuyScreen, { ...props }) });
}
...
var SignatureScreen = (props) => {
  ...
  if (!wallet) {
    return (0, import_jsx_runtime56.jsx)(LoadingScreen, {});
  }
  if (wallet.id === "inApp" || wallet.id === "embedded" || wallet.id === "smart" && (adminWallet == null ? void 0 : adminWallet.id) === "inApp") {
    return (0, import_jsx_runtime56.jsx)(HeadlessSignIn, { signIn, status, connectLocale, wallet });
  }
  const handleRetry = () => {
    signIn();
  };
  return (0, import_jsx_runtime56.jsxs)(Container, { animate: "fadein", fullHeight: true, flex: "column", children: [(0, import_jsx_runtime56.jsx)(Container, { p: "lg", style: {
    paddingBottom: 0
  }, children: (0, import_jsx_runtime56.jsx)(ModalHeader, { title: locale.instructionScreen.title }) }), (0, import_jsx_runtime56.jsx)(Container, { style: {
    paddingTop: 0,
    paddingBottom: spacing.xl
  }, flex: "column", px: modalSize === "compact" ? "lg" : "xxl", center: "y", expand: true, children: status === "idle" ? (0, import_jsx_runtime56.jsxs)(import_jsx_runtime56.Fragment, { children: [(0, import_jsx_runtime56.jsx)(Container, { flex: "row", center: "x", animate: "fadein", py: "3xl", children: (0, import_jsx_runtime56.jsx)(PulsatingContainer, { children: (0, import_jsx_runtime56.jsx)(WalletImage, { id: wallet.id, client: props.client, size: "80" }) }) }), (0, import_jsx_runtime56.jsx)(Text, { center: true, multiline: true, balance: true, children: locale.instructionScreen.instruction }), (0, import_jsx_runtime56.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime56.jsx)(Button, { fullWidth: true, variant: "accent", onClick: signIn, style: {
    alignItems: "center",
    padding: spacing.md
  }, children: connectLocale.signatureScreen.instructionScreen.signInButton }), (0, import_jsx_runtime56.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime56.jsx)(Button, { fullWidth: true, variant: "secondary", onClick: () => {
    disconnect(wallet);
  }, style: {
    alignItems: "center",
    padding: spacing.md
  }, children: connectLocale.signatureScreen.instructionScreen.disconnectWallet })] }) : (0, import_jsx_runtime56.jsxs)(import_jsx_runtime56.Fragment, { children: [(0, import_jsx_runtime56.jsx)(Container, { py: "3xl", children: (0, import_jsx_runtime56.jsx)(WalletLogoSpinner, { client: props.client, error: status === "failed", id: wallet.id }) }), (0, import_jsx_runtime56.jsxs)(Container, { flex: "column", gap: "md", animate: "fadein", children: [(0, import_jsx_runtime56.jsx)(Text, { size: "lg", center: true, color: "primaryText", children: status === "failed" ? locale.signingScreen.failedToSignIn : locale.signingScreen.inProgress }), status === "signing" && (0, import_jsx_runtime56.jsx)(Text, { center: true, multiline: true, balance: true, children: connectLocale.signatureScreen.signingScreen.prompt }), status === "failed" && (0, import_jsx_runtime56.jsxs)(Container, { children: [(0, import_jsx_runtime56.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime56.jsxs)(Button, { fullWidth: true, variant: "accent", onClick: handleRetry, style: {
    gap: spacing.xs,
    alignItems: "center",
    padding: spacing.md
  }, children: [(0, import_jsx_runtime56.jsx)(ReloadIcon, { width: iconSize.sm, height: iconSize.sm }), locale.signingScreen.tryAgain] }), (0, import_jsx_runtime56.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime56.jsx)(Button, { fullWidth: true, variant: "secondary", onClick: () => {
    disconnect(wallet);
  }, style: {
    alignItems: "center",
    padding: spacing.md
  }, children: locale.instructionScreen.disconnectWallet })] })] }, status)] }) }), (termsOfServiceUrl || privacyPolicyUrl) && (0, import_jsx_runtime56.jsx)(Container, { p: "md", animate: "fadein", children: (0, import_jsx_runtime56.jsx)(TOS, { termsOfServiceUrl, privacyPolicyUrl, locale: connectLocale.agreement }) })] });
};
function HeadlessSignIn({ signIn, status, connectLocale, wallet }) {
  ...
  return (0, import_jsx_runtime56.jsxs)(Container, { p: "lg", fullHeight: true, flex: "column", animate: "fadein", children: [(0, import_jsx_runtime56.jsx)(ModalHeader, { title: locale.signingScreen.title }), (0, import_jsx_runtime56.jsxs)(Container, { expand: true, flex: "row", center: "both", style: {
    minHeight: "250px"
  }, children: [status === "signing" && (0, import_jsx_runtime56.jsx)(Spinner, { size: "xl", color: "accentText" }), status === "failed" && (0, import_jsx_runtime56.jsxs)(Container, { children: [(0, import_jsx_runtime56.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime56.jsx)(Text, { size: "lg", center: true, color: "danger", children: locale.signingScreen.failedToSignIn }), (0, import_jsx_runtime56.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime56.jsxs)(Button, { fullWidth: true, variant: "accent", onClick: () => {
    signIn();
  }, style: {
    gap: spacing.xs,
    alignItems: "center",
...
function StartScreen(props) {
  ...
  if (WelcomeScreen) {
    if (typeof WelcomeScreen === "function") {
      return (0, import_jsx_runtime58.jsx)(WelcomeScreen, {});
    }
  }
  ...
  return (0, import_jsx_runtime58.jsxs)(Container, { fullHeight: true, animate: "fadein", flex: "column", children: [(0, import_jsx_runtime58.jsxs)(Container, { expand: true, flex: "column", center: "both", style: {
    minHeight: "300px"
  }, p: "lg", children: [(0, import_jsx_runtime58.jsx)(Container, { flex: "row", center: "x", children: img ? (0, import_jsx_runtime58.jsx)(Img, { src: img.src, width: img.width ? String(img.width) : void 0, height: img.height ? String(img.height) : void 0, client: props.client }) : (0, import_jsx_runtime58.jsx)(GlobalContainer, { children: (0, import_jsx_runtime58.jsx)(GlobeIcon, { size: "150" }) }) }), (0, import_jsx_runtime58.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime58.jsx)(Text, { center: true, color: "primaryText", weight: 600, multiline: true, children: title }), (0, import_jsx_runtime58.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime58.jsx)(Text, { color: "secondaryText", multiline: true, style: {
    textAlign: "center"
  }, children: subtitle }), (0, import_jsx_runtime58.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime58.jsx)(Link, { target: "_blank", center: true, href: "https://blog.thirdweb.com/web3-wallet/", children: props.connectLocale.newToWallets })] }), (0, import_jsx_runtime58.jsx)(Container, { py: "lg", flex: "column", gap: "lg", children: (0, import_jsx_runtime58.jsxs)("div", { children: [showTOS && (0, import_jsx_runtime58.jsx)(TOS, { termsOfServiceUrl: props.meta.termsOfServiceUrl, privacyPolicyUrl: props.meta.privacyPolicyUrl, locale: props.connectLocale.agreement }), props.meta.showThirdwebBranding !== false && (0, import_jsx_runtime58.jsx)(Container, { style: {
    paddingTop: spacing.xl
  }, children: (0, import_jsx_runtime58.jsx)(PoweredByThirdweb, {}) })] }) })] });
}
...
function ConnectModalWideLayout(props) {
  return (0, import_jsx_runtime59.jsxs)("div", { style: {
    height: "100%",
    display: "grid",
    gridTemplateColumns: "300px 1fr"
  }, children: [(0, import_jsx_runtime59.jsxs)(LeftContainer, { children: [" ", props.left, " "] }), (0, import_jsx_runtime59.jsx)(Container, { flex: "column", scrollY: true, relative: true, children: props.right })] });
}
function ConnectModalCompactLayout(props) {
  return (0, import_jsx_runtime59.jsx)(Container, { flex: "column", scrollY: true, relative: true, style: {
    maxHeight: compactModalMaxHeight
  }, children: props.children });
}
...
// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/Modal/ConnectModalContent.js
var AllWalletsUI = (0, import_react38.lazy)(() => import("./AllWalletsUI-BCWBXRJJ.js"));
var ConnectModalContent = (props) => {
  ...
  const walletList = (0, import_jsx_runtime60.jsx)(WalletSelector, { title: props.meta.title || props.connectLocale.defaultModalTitle, wallets: props.wallets, selectWallet: (newWallet) => {
  ...
  const showAll = (0, import_jsx_runtime60.jsx)(import_react38.Suspense, { fallback: (0, import_jsx_runtime60.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime60.jsx)(AllWalletsUI, { onBack: handleBack, onSelect: setScreen, client: props.client, connectLocale: props.connectLocale, recommendedWallets: props.recommendedWallets, specifiedWallets: props.wallets, size: props.size }) });
  const getStarted = (0, import_jsx_runtime60.jsx)(StartScreen, { client: props.client, connectLocale: props.connectLocale, meta: props.meta, welcomeScreen: props.welcomeScreen });
  const goBack = props.wallets.length > 1 ? handleBack : void 0;
  const getWalletUI = (wallet) => {
    if (props.accountAbstraction) {
      return (0, import_jsx_runtime60.jsx)(SmartConnectUI, { accountAbstraction: props.accountAbstraction, done: (smartWallet2) => {
    ...
    return (0, import_jsx_runtime60.jsx)(AnyWalletConnectUI, { wallet, onBack: goBack, done: () => {
  ...
  const signatureScreen = (0, import_jsx_runtime60.jsx)(SignatureScreen, { onDone: onClose, modalSize: props.size, termsOfServiceUrl: props.meta.termsOfServiceUrl, privacyPolicyUrl: props.meta.privacyPolicyUrl, auth: props.auth, client: props.client, connectLocale: props.connectLocale });
  return (0, import_jsx_runtime60.jsx)(ScreenSetupContext.Provider, { value: props.screenSetup, children: props.size === "wide" ? (0, import_jsx_runtime60.jsx)(ConnectModalWideLayout, { left: walletList, right: (0, import_jsx_runtime60.jsxs)(import_jsx_runtime60.Fragment, { children: [screen === reservedScreens.signIn && signatureScreen, screen === reservedScreens.main && getStarted, screen === reservedScreens.getStarted && getStarted, screen === reservedScreens.showAll && showAll, typeof screen !== "string" && getWalletUI(screen)] }) }) : (0, import_jsx_runtime60.jsxs)(ConnectModalCompactLayout, { children: [screen === reservedScreens.signIn && signatureScreen, screen === reservedScreens.main && walletList, screen === reservedScreens.getStarted && getStarted, screen === reservedScreens.showAll && showAll, typeof screen !== "string" && getWalletUI(screen)] }) });
};
...
function WalletSwitcherConnectionScreen(props) {
  ...
  return (0, import_jsx_runtime61.jsx)(ConnectModalContent, { accountAbstraction: props.accountAbstraction, auth: void 0, chain: props.chain, chains: props.chains, client: props.client, connectLocale: props.connectLocale, hideHeader: props.isEmbed, isOpen: true, meta: {
...
function formatTokenBalance(balanceData, showSymbol = true) {
  return formatNumber(Number(balanceData.displayValue), 5) + (showSymbol ? ` ${balanceData.symbol}` : "");
}
...
function WalletManagerScreen(props) {
  ...
  if (screen === "connect") {
    return (0, import_jsx_runtime62.jsx)(WalletSwitcherConnectionScreen, { ...props, isEmbed: false, onSelect: (w) => {
      setActive(w);
      props.onBack();
    } });
  }
  return (0, import_jsx_runtime62.jsxs)(Container, { children: [(0, import_jsx_runtime62.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime62.jsx)(ModalHeader, { title: "Wallets", onBack: props.onBack }) }), (0, import_jsx_runtime62.jsx)(Line, {}), (0, import_jsx_runtime62.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime62.jsx)(Container, { px: "md", style: {
    minHeight: "150px"
  }, children: (0, import_jsx_runtime62.jsx)(Container, { flex: "column", gap: "xs", children: connectedWallets.filter((w) => {
    var _a2;
    return !((_a2 = props.hiddenWallets) == null ? void 0 : _a2.includes(w.id));
  }).map((w) => {
    return (0, import_jsx_runtime62.jsx)(WalletManangerButton, {
      client: props.client,
      // address={address || ""}
      onClick: () => {
        setActive(w);
  ...
  }) }) }), (0, import_jsx_runtime62.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime62.jsx)(Container, { p: "lg", children: !hideConnectButton && (0, import_jsx_runtime62.jsxs)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    setScreen("connect");
  }, gap: "xs", children: [(0, import_jsx_runtime62.jsx)(PlusIcon, { width: iconSize.sm, height: iconSize.sm }), "Connect Wallet"] }) })] });
}
function WalletManangerButton(props) {
  ...
  return (0, import_jsx_runtime62.jsxs)("div", { style: {
    position: "relative"
  }, children: [(0, import_jsx_runtime62.jsx)(WalletButtonEl, { onClick: props.onClick, style: {
    justifyContent: "space-between"
  }, children: (0, import_jsx_runtime62.jsxs)(Container, { flex: "row", gap: "md", center: "y", children: [(0, import_jsx_runtime62.jsx)(WalletImage, { client: props.client, id: walletId, size: iconSize.lg }), (0, import_jsx_runtime62.jsxs)(Container, { flex: "column", gap: "4xs", children: [(0, import_jsx_runtime62.jsx)(Text, { color: "primaryText", children: shortenAddress(address || "") }), balanceQuery.data ? (0, import_jsx_runtime62.jsx)(Text, { size: "xs", color: "secondaryText", weight: 400, children: formatTokenBalance(balanceQuery.data) }) : (0, import_jsx_runtime62.jsx)(Skeleton, { width: "100px", height: fontSize.sm })] })] }) }), (0, import_jsx_runtime62.jsx)("div", { style: {
    position: "absolute",
    zIndex: 1,
    right: spacing.xxs,
    top: "50%",
    transform: "translateY(-50%)"
  }, children: (activeWallet == null ? void 0 : activeWallet.id) === props.wallet.id ? (0, import_jsx_runtime62.jsx)(ToolTip, { tip: "Active Wallet", children: (0, import_jsx_runtime62.jsx)(IconButton, { children: (0, import_jsx_runtime62.jsx)(CheckIcon, { width: iconSize.md, height: iconSize.md }) }) }) : (0, import_jsx_runtime62.jsx)(ToolTip, { tip: "Disconnect", children: (0, import_jsx_runtime62.jsx)(IconButton, { onClick: () => {
    disconnect(props.wallet);
  }, children: (0, import_jsx_runtime62.jsx)(MinusIcon, { width: iconSize.md, height: iconSize.md, style: {
    color: theme.colors.secondaryText
  } }) }) }) })] });
}
...
var InAppWalletConnectUI = (0, import_react40.lazy)(() => import("./InAppWalletConnectUI-ZI3DJ7VN.js"));
function LinkProfileScreen(props) {
  const activeWallet = useAdminWallet();
  const chain = useActiveWalletChain();
  const queryClient = useQueryClient();
  if (!activeWallet) {
    return (0, import_jsx_runtime63.jsx)(LoadingScreen, {});
  }
  if (activeWallet.id === "inApp") {
    return (0, import_jsx_runtime63.jsx)(import_react40.Suspense, { fallback: (0, import_jsx_runtime63.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime63.jsx)(InAppWalletConnectUI, { walletConnect: props.walletConnect, wallet: activeWallet, done: () => {
  ...
  if (isEcosystemWallet(activeWallet)) {
    return (0, import_jsx_runtime63.jsx)(import_react40.Suspense, { fallback: (0, import_jsx_runtime63.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime63.jsx)(EcosystemWalletConnectUI_default, { wallet: activeWallet, done: () => {
      queryClient.invalidateQueries({ queryKey: ["profiles"] });
      props.onBack();
    }, connectLocale: props.locale, client: props.client, size: "compact", chain, meta: {
      title: props.locale.manageWallet.linkProfile,
  ...
  return (0, import_jsx_runtime63.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime63.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime63.jsx)(ModalHeader, { title: props.locale.manageWallet.linkProfile, onBack: props.onBack }) }), (0, import_jsx_runtime63.jsx)(Line, {}), (0, import_jsx_runtime63.jsxs)(Container, { flex: "column", gap: "md", center: "both", px: "xl", color: "secondaryText", style: {
    flex: "1",
    minHeight: "250px"
  }, children: [(0, import_jsx_runtime63.jsx)(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime63.jsx)(Text, { center: true, children: "This wallet does not support account linking" })] })] });
}
...
function useProfiles(args) {
  ...
  return useQuery({
    queryKey: ["profiles", wallet == null ? void 0 : wallet.id],
...
var AddUserIcon = (props) => {
  return (0, import_jsx_runtime64.jsx)("svg", { width: props.size, height: props.size, viewBox: "0 0 24 24", fill: "none", role: "presentation", xmlns: "http://www.w3.org/2000/svg", children: (0, import_jsx_runtime64.jsx)("path", { d: "M12 15.5H7.5C6.10444 15.5 5.40665 15.5 4.83886 15.6722C3.56045 16.06 2.56004 17.0605 2.17224 18.3389C2 18.9067 2 19.6044 2 21M19 21V15M16 18H22M14.5 7.5C14.5 9.98528 12.4853 12 10 12C7.51472 12 5.5 9.98528 5.5 7.5C5.5 5.01472 7.51472 3 10 3C12.4853 3 14.5 5.01472 14.5 7.5Z", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) });
};
...
function LinkedProfilesScreen(props) {
  ...
  if (isLoading) {
    return (0, import_jsx_runtime65.jsx)(LoadingScreen, {});
  }
  return (0, import_jsx_runtime65.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime65.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime65.jsx)(ModalHeader, { title: props.locale.manageWallet.linkedProfiles, onBack: props.onBack }) }), (0, import_jsx_runtime65.jsx)(Line, {}), isLoading ? (0, import_jsx_runtime65.jsx)(LoadingScreen, {}) : (0, import_jsx_runtime65.jsxs)(Container, { scrollY: true, style: {
    height: "300px"
  }, children: [(0, import_jsx_runtime65.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime65.jsxs)(Container, { px: "sm", children: [(0, import_jsx_runtime65.jsxs)(MenuButton, { onClick: () => {
    props.setScreen("link-profile");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime65.jsx)(AddUserIcon, { size: iconSize.md }), (0, import_jsx_runtime65.jsx)(Text, { color: "primaryText", children: props.locale.manageWallet.linkProfile })] }), (0, import_jsx_runtime65.jsx)(Spacer, { y: "xs" }), connectedProfiles == null ? void 0 : connectedProfiles.filter((profile) => profile.type !== "guest").map((profile) => (0, import_jsx_runtime65.jsx)(LinkedProfile, { profile, client: props.client }, `${profile.type}-${getProfileDisplayName(profile)}`))] }), (0, import_jsx_runtime65.jsx)(Spacer, { y: "md" })] })] });
}
function LinkedProfile({ profile, client }) {
  ...
  return (0, import_jsx_runtime65.jsxs)(MenuButton, { style: {
    fontSize: fontSize.sm,
    cursor: "default"
  }, disabled: true, children: [(socialProfiles == null ? void 0 : socialProfiles.some((p) => p.avatar)) ? (0, import_jsx_runtime65.jsx)(Img, { src: (_a = socialProfiles == null ? void 0 : socialProfiles.find((p) => p.avatar)) == null ? void 0 : _a.avatar, width: iconSize.lg, height: iconSize.lg, loading: "eager", client, style: {
    borderRadius: "100%"
  } }) : profile.details.address !== void 0 ? (0, import_jsx_runtime65.jsx)(Container, { style: {
    width: "32px",
    height: "32px",
    borderRadius: "100%",
    overflow: "hidden"
  }, children: (0, import_jsx_runtime65.jsx)(Blobbie, { address: profile.details.address, size: 32 }) }) : (0, import_jsx_runtime65.jsx)(Img, { src: getWalletIcon(profile.type), width: iconSize.lg, height: iconSize.lg, loading: "eager", client }), (0, import_jsx_runtime65.jsxs)("div", { style: {
    display: "flex",
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
    flexGrow: 1
  }, children: [(0, import_jsx_runtime65.jsx)(Text, { color: "primaryText", children: ((_b = socialProfiles == null ? void 0 : socialProfiles.find((p) => p.avatar)) == null ? void 0 : _b.name) || getProfileDisplayName(profile) }), ((_c = socialProfiles == null ? void 0 : socialProfiles.find((p) => p.avatar)) == null ? void 0 : _c.name) && profile.details.address && (0, import_jsx_runtime65.jsx)(Text, { color: "secondaryText", size: "sm", children: shortenAddress(profile.details.address, 4) })] })] });
}
...
var KeyIcon = (props) => {
  return (0, import_jsx_runtime66.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 24 24", fill: "none", role: "presentation", children: [(0, import_jsx_runtime66.jsx)("path", { d: "M2 5.99999L2 2.99999C2 2.39999 2.4 1.99999 3 1.99999H7L7 4.99999H10V7.99999H12L13.4 9.39999C14.7898 8.91585 16.3028 8.9177 17.6915 9.40524C19.0801 9.89278 20.2622 10.8372 21.0444 12.0839C21.8265 13.3306 22.1624 14.8058 21.9971 16.2683C21.8318 17.7307 21.1751 19.0937 20.1344 20.1344C19.0937 21.1751 17.7307 21.8318 16.2683 21.9971C14.8058 22.1624 13.3306 21.8265 12.0839 21.0444C10.8372 20.2622 9.89279 19.0801 9.40525 17.6915C8.91771 16.3028 8.91585 14.7898 9.4 13.4L2 5.99999Z", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime66.jsx)("path", { d: "M15.5 15C15.7761 15 16 15.2239 16 15.5C16 15.7761 15.7761 16 15.5 16C15.2239 16 15 15.7761 15 15.5C15 15.2239 15.2239 15 15.5 15Z", fill: "currentColor", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })] });
};
...
function ManageWalletScreen(props) {
  ...
  return (0, import_jsx_runtime69.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime69.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime69.jsx)(ModalHeader, { title: props.locale.manageWallet.title, onBack: props.onBack }) }), (0, import_jsx_runtime69.jsx)(Line, {}), (0, import_jsx_runtime69.jsxs)(Container, { px: "sm", scrollY: true, style: {
    maxHeight: "500px"
  }, children: [(0, import_jsx_runtime69.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime69.jsxs)(Container, { style: { position: "relative", height: "250px" }, children: [(0, import_jsx_runtime69.jsx)(SwitchMetamaskAccount, { closeModal: props.closeModal, connectLocale: props.locale }), activeWallet && ((activeWallet == null ? void 0 : activeWallet.id) === "inApp" || isEcosystemWallet(activeWallet)) && (0, import_jsx_runtime69.jsxs)(MenuButton, { onClick: () => {
    props.setScreen("linked-profiles");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime69.jsx)(MultiUserIcon, { size: iconSize.md }), (0, import_jsx_runtime69.jsx)(Text, { color: "primaryText", children: props.locale.manageWallet.linkedProfiles })] }), (0, import_jsx_runtime69.jsxs)(MenuButton, { onClick: () => {
    props.setScreen("wallet-connect-receiver");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime69.jsx)(WalletConnectIcon, { size: iconSize.md }), (0, import_jsx_runtime69.jsx)(Text, { color: "primaryText", children: props.locale.manageWallet.connectAnApp })] }), activeWallet && isInAppWallet(activeWallet) && !((_a = activeWallet.getConfig()) == null ? void 0 : _a.hidePrivateKeyExport) && (0, import_jsx_runtime69.jsxs)(MenuButton, { onClick: () => {
    props.setScreen("private-key");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime69.jsx)(KeyIcon, { size: iconSize.md }), (0, import_jsx_runtime69.jsx)(Text, { color: "primaryText", children: props.locale.manageWallet.exportPrivateKey })] })] }), (0, import_jsx_runtime69.jsx)(Spacer, { y: "lg" })] })] });
}
function SwitchMetamaskAccount(props) {
  ...
  return (0, import_jsx_runtime69.jsxs)(MenuButton, { type: "button", onClick: async () => {
    await injectedMetamaskProvider.request({
      method: "wallet_requestPermissions",
      params: [{ eth_accounts: {} }]
    });
    props.closeModal();
  }, children: [(0, import_jsx_runtime69.jsx)(ShuffleIcon, { width: iconSize.md, height: iconSize.md }), (0, import_jsx_runtime69.jsx)(Text, { color: "primaryText", children: connectLocale.switchAccount })] });
}
...
function PrivateKey(props) {
  ...
  return (0, import_jsx_runtime70.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime70.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime70.jsx)(ModalHeader, { title: "Export Private Key", onBack: props.onBack }) }), (0, import_jsx_runtime70.jsx)(Line, {}), (0, import_jsx_runtime70.jsxs)(Container, { px: "sm", scrollY: true, style: {
    maxHeight: "500px"
  }, children: [(0, import_jsx_runtime70.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime70.jsxs)(Container, { style: { position: "relative", height: "250px" }, children: [isLoading ? (0, import_jsx_runtime70.jsx)(Container, { center: "both", flex: "column", style: { position: "absolute", width: "100%", height: "100%" }, children: (0, import_jsx_runtime70.jsx)(Spinner, { size: "lg", color: "primaryButtonBg" }) }) : (0, import_jsx_runtime70.jsx)(import_jsx_runtime70.Fragment, {}), (0, import_jsx_runtime70.jsx)(Container, { style: {
    position: "absolute",
    height: "100%",
    width: "100%",
    zIndex: 11
  }, children: (0, import_jsx_runtime70.jsx)("iframe", { title: "Export In-App Wallet", style: {
    width: "100%",
    height: "250px",
    visibility: isLoading ? "hidden" : "unset"
  }, onLoad: () => {
    setLoading(false);
  }, allow: "clipboard-read; clipboard-write", src: `${baseDomain.includes("localhost") ? "http" : "https"}://${baseDomain}/sdk/2022-08-12/embedded-wallet/export-private-key?clientId=${props.client.clientId}&theme=${typeof props.theme === "string" ? props.theme : props.theme.type}${ecosystem ? `&ecosystemId=${ecosystem.id}` : ""}${(ecosystem == null ? void 0 : ecosystem.partnerId) ? `&partnerId=${ecosystem.partnerId}` : ""}` }) })] }), (0, import_jsx_runtime70.jsx)(Spacer, { y: "lg" })] })] });
}
...
function ReceiveFunds(props) {
  ...
  return (0, import_jsx_runtime71.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime71.jsx)(ModalHeader, { title: locale.title, onBack: props.onBack }), (0, import_jsx_runtime71.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime71.jsx)(Container, { flex: "row", center: "x", children: (0, import_jsx_runtime71.jsx)(QRCode, { qrCodeUri: address, size: 310, QRIcon: props.walletId && (0, import_jsx_runtime71.jsx)(WalletImage, { id: props.walletId, size: iconSize.xxl, client }) }) }), (0, import_jsx_runtime71.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime71.jsxs)(WalletAddressContainer, { onClick: onCopy, children: [(0, import_jsx_runtime71.jsx)(Text, { color: "primaryText", size: "md", children: shortenString(address || "") }), (0, import_jsx_runtime71.jsx)(CopyIcon2, { text: address || "", tip: "Copy address", hasCopied })] }), (0, import_jsx_runtime71.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime71.jsx)(Text, { multiline: true, center: true, balance: true, children: locale.instruction })] });
}
...
async function getTokenBalance(options) {
  ...
  if (tokenAddress) {
    const { getBalance } = await import("./getBalance-WJZEBXUS.js");
    return getBalance({
...
function useTokenInfo(options) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (tokenAddress) {
        const { getCurrencyMetadata: getCurrencyMetadata2 } = await import("./getCurrencyMetadata-QST2KDN5.js");
        const result2 = await getCurrencyMetadata2({
          contract: getContract({ client, chain, address: tokenAddress })
        });
        return result2;
      }
      const { getChainDecimals: getChainDecimals2, getChainNativeCurrencyName: getChainNativeCurrencyName2, getChainSymbol: getChainSymbol2 } = await import("./utils-OGKE4Q73.js");
...
function TokenSelector(props) {
  ...
  if (screen === "select-chain" && chainSelection) {
    return (0, import_jsx_runtime72.jsx)(NetworkSelectorContent, {
      client: props.client,
      ...
      networkSelector: {
        renderChain(renderChainProps) {
          return (0, import_jsx_runtime72.jsx)(ChainButton, { chain: renderChainProps.chain, confirming: false, switchingFailed: false, onClick: () => {
  ...
  return (0, import_jsx_runtime72.jsxs)(Container, { animate: "fadein", style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime72.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime72.jsx)(ModalHeader, { onBack: props.onBack, title: props.modalTitle || locale.selectTokenTitle }) }), (0, import_jsx_runtime72.jsx)(Line, {}), (0, import_jsx_runtime72.jsxs)(Container, { scrollY: true, style: {
    maxHeight: "450px"
  }, children: [(0, import_jsx_runtime72.jsx)(Spacer, { y: "md" }), props.chainSelection && (0, import_jsx_runtime72.jsxs)(Container, { px: "lg", children: [(0, import_jsx_runtime72.jsx)(Text, { size: "sm", children: "Select Network" }), (0, import_jsx_runtime72.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime72.jsxs)(SelectTokenBtn, { fullWidth: true, variant: "secondary", onClick: () => {
    setScreen("select-chain");
  }, children: [(0, import_jsx_runtime72.jsx)(ChainIcon, { chainIconUrl: chainIconQuery.url, size: iconSize.lg, client: props.client }), chainNameQuery.name ? (0, import_jsx_runtime72.jsx)(Text, { color: "primaryText", size: "sm", children: chainNameQuery.name }) : (0, import_jsx_runtime72.jsx)(Skeleton, { height: fontSize.md }), (0, import_jsx_runtime72.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    marginLeft: "auto"
  } })] }), (0, import_jsx_runtime72.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime72.jsx)(Text, { size: "sm", children: "Select Token" })] }), (0, import_jsx_runtime72.jsxs)(Container, { px: "lg", children: [(0, import_jsx_runtime72.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime72.jsx)(Input, { placeholder: locale.searchToken, variant: "outline", value: input, onChange: (e) => {
    setInput(e.target.value);
  } })] }), (0, import_jsx_runtime72.jsx)(Spacer, { y: "md" }), (filteredList.length > 0 || !input) && (0, import_jsx_runtime72.jsxs)(Container, { flex: "column", gap: "xs", px: "lg", scrollY: true, style: {
    paddingTop: 0,
    paddingBottom: spacing.lg
    // maxHeight: props.chainSelection ? "300px" : "400px",
  }, children: [!input && (0, import_jsx_runtime72.jsx)(SelectTokenButton, { onClick: () => {
    props.onTokenSelect(NATIVE_TOKEN);
  }, chain: props.chain, token: NATIVE_TOKEN, client: props.client }), filteredList.map((token) => {
    return (0, import_jsx_runtime72.jsx)(SelectTokenButton, { onClick: () => props.onTokenSelect(token), token, chain: props.chain, client: props.client }, token.address);
  })] }), filteredList.length === 0 && tokenQuery.isLoading && input && (0, import_jsx_runtime72.jsx)(Container, { animate: "fadein", p: "lg", flex: "column", gap: "md", center: "both", style: {
    minHeight: "200px",
    paddingTop: 0
  }, color: "secondaryText", children: (0, import_jsx_runtime72.jsx)(Spinner, { size: "lg", color: "accentText" }) }), filteredList.length === 0 && !tokenQuery.isLoading && input && (0, import_jsx_runtime72.jsxs)(Container, { animate: "fadein", p: "lg", flex: "column", gap: "md", center: "both", style: {
    minHeight: "200px",
    paddingTop: 0
  }, color: "secondaryText", children: [(0, import_jsx_runtime72.jsx)(CrossCircledIcon, { width: iconSize.lg, height: iconSize.lg }), locale.noTokensFound] }), (0, import_jsx_runtime72.jsx)(Spacer, { y: "md" })] })] });
}
function SelectTokenButton(props) {
  ...
  return (0, import_jsx_runtime72.jsxs)(SelectTokenBtn, { fullWidth: true, variant: "secondary", onClick: props.onClick, children: [(0, import_jsx_runtime72.jsx)(TokenIcon, { token: props.token, chain: props.chain, size: "lg", client: props.client }), (0, import_jsx_runtime72.jsxs)(Container, { flex: "column", gap: "xxs", children: [tokenName ? (0, import_jsx_runtime72.jsx)(Text, { size: "sm", color: "primaryText", children: tokenName }) : (0, import_jsx_runtime72.jsx)(Skeleton, { height: fontSize.md, width: "150px" }), account && (0, import_jsx_runtime72.jsx)(TokenBalance, { account, chain: props.chain, client: props.client, tokenAddress: isNativeToken(props.token) ? void 0 : props.token.address })] })] });
}
function TokenBalance(props) {
  ...
  if (tokenBalanceQuery.data) {
    return (0, import_jsx_runtime72.jsxs)(Text, { size: "xs", children: [" ", formatTokenBalance(tokenBalanceQuery.data)] });
  }
  return (0, import_jsx_runtime72.jsx)(Skeleton, { height: fontSize.xs, width: "100px" });
}
...
function SendFunds(props) {
  ...
  if (screen === "tokenSelector" && chain) {
    return (0, import_jsx_runtime73.jsx)(TokenSelector, { tokenList, onBack: () => {
      setScreen("base");
  ...
  return (0, import_jsx_runtime73.jsx)(SendFundsForm, { token, onTokenSelect: () => {
...
function SendFundsForm(props) {
  ...
  if (sendTokenMutation.isError) {
    return (0, import_jsx_runtime73.jsxs)(Container, { p: "lg", animate: "fadein", children: [(0, import_jsx_runtime73.jsx)(ModalHeader, { title: locale.title, onBack: () => {
      sendTokenMutation.reset();
    } }), (0, import_jsx_runtime73.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime73.jsxs)(Container, { flex: "column", gap: "lg", animate: "fadein", center: "both", style: {
      minHeight: "200px"
    }, color: "danger", children: [(0, import_jsx_runtime73.jsx)(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime73.jsx)(Text, { center: true, multiline: true, color: "danger", children: getErrorMessage(sendTokenMutation.error) })] })] });
  }
  if (sendTokenMutation.isSuccess) {
    return (0, import_jsx_runtime73.jsxs)(Container, { p: "lg", animate: "fadein", children: [(0, import_jsx_runtime73.jsx)(ModalHeader, { title: locale.title, onBack: () => {
      sendTokenMutation.reset();
    } }), (0, import_jsx_runtime73.jsxs)(Container, { flex: "column", gap: "lg", animate: "fadein", center: "both", style: {
      minHeight: "250px"
    }, color: "success", children: [(0, import_jsx_runtime73.jsx)(CheckCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime73.jsxs)(Text, { color: "success", children: [" ", locale.successMessage, " "] })] })] });
  }
  ...
  return (0, import_jsx_runtime73.jsxs)(Container, { p: "lg", animate: "fadein", children: [(0, import_jsx_runtime73.jsx)(ModalHeader, { title: locale.title, onBack: props.onBack }), (0, import_jsx_runtime73.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime73.jsxs)("form", { onSubmit: (e) => {
    e.preventDefault();
  }, children: [(0, import_jsx_runtime73.jsx)(Label, { htmlFor: "token", color: "secondaryText", children: locale.token }), (0, import_jsx_runtime73.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime73.jsxs)(Button, { id: "token", variant: "outline", fullWidth: true, style: {
    justifyContent: "flex-start",
    gap: spacing.sm,
    padding: spacing.sm
  }, onClick: props.onTokenSelect, children: [(0, import_jsx_runtime73.jsx)(TokenIcon, { token: props.token, chain: activeChain, size: "lg", client: props.client }), (0, import_jsx_runtime73.jsxs)(Container, { flex: "column", gap: "xs", children: [tokenName ? (0, import_jsx_runtime73.jsx)(Text, { size: "sm", color: "primaryText", children: tokenName }) : (0, import_jsx_runtime73.jsx)(Skeleton, { height: fontSize.xs, width: "150px" }), balanceQuery.data ? (0, import_jsx_runtime73.jsx)(Text, { size: "xs", children: formatTokenBalance(balanceQuery.data) }) : (0, import_jsx_runtime73.jsx)(Skeleton, { height: fontSize.xs, width: "100px" })] })] }), (0, import_jsx_runtime73.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime73.jsx)(Label, { htmlFor: "receiver", color: "secondaryText", children: locale.sendTo }), (0, import_jsx_runtime73.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime73.jsx)(Input, { required: true, id: "receiver", placeholder: "0x... or ENS name", variant: "outline", value: receiverAddress, onChange: (e) => {
    setReceiverAddress(e.target.value);
  } }), (0, import_jsx_runtime73.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime73.jsx)(Label, { htmlFor: "amount", color: "secondaryText", children: locale.amount }), (0, import_jsx_runtime73.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime73.jsxs)(Container, { relative: true, children: [(0, import_jsx_runtime73.jsx)(Input, { required: true, type: "number", id: "amount", variant: "outline", value: amount, onChange: (e) => {
    setAmount(e.target.value);
  } }), (0, import_jsx_runtime73.jsx)(CurrencyBadge, { children: (0, import_jsx_runtime73.jsxs)(Text, { size: "xs", children: [" ", tokenSymbol, " "] }) })] }), (0, import_jsx_runtime73.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime73.jsxs)(Button, { fullWidth: true, variant: "accent", type: "submit", onClick: async () => {
    ...
    gap: spacing.sm,
    padding: spacing.md
  }, children: [sendTokenMutation.isPending && (0, import_jsx_runtime73.jsx)(Spinner, { size: "sm", color: "accentButtonText" }), sendTokenMutation.isPending ? locale.sending : locale.submitButton] })] })] });
}
...
var ImageIcon = (props) => {
  return (0, import_jsx_runtime74.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", role: "presentation", children: [(0, import_jsx_runtime74.jsx)("rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", ry: "2" }), (0, import_jsx_runtime74.jsx)("circle", { cx: "9", cy: "9", r: "2" }), (0, import_jsx_runtime74.jsx)("path", { d: "m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21" })] });
};
...
var CarbonDocumentUnknown = (props) => {
  return (0, import_jsx_runtime75.jsxs)("svg", { width: "16", height: "16", viewBox: "0 0 32 32", role: "presentation", ...props, children: [(0, import_jsx_runtime75.jsx)("circle", { cx: "9", cy: "28.5", r: "1.5", fill: "currentColor" }), (0, import_jsx_runtime75.jsx)("path", { fill: "currentColor", d: "M10 25H8v-4h2a2 2 0 0 0 0-4H8a2.002 2.002 0 0 0-2 2v.5H4V19a4.005 4.005 0 0 1 4-4h2a4 4 0 0 1 0 8Z" }), (0, import_jsx_runtime75.jsx)("path", { fill: "currentColor", d: "m27.7 9.3l-7-7A.908.908 0 0 0 20 2H10a2.006 2.006 0 0 0-2 2v8h2V4h8v6a2.006 2.006 0 0 0 2 2h6v16H14v2h12a2.006 2.006 0 0 0 2-2V10a.91.91 0 0 0-.3-.7ZM20 10V4.4l5.6 5.6Z" })] });
};
var CarbonDocumentAudio = (props) => {
  return (0, import_jsx_runtime75.jsxs)("svg", { width: "16", height: "16", viewBox: "0 0 32 32", role: "presentation", ...props, children: [(0, import_jsx_runtime75.jsx)("path", { fill: "currentColor", d: "M29 31a.999.999 0 0 1-.625-.22L23.65 27H20a1 1 0 0 1-1-1v-5a1 1 0 0 1 1-1h3.65l4.726-3.78A1 1 0 0 1 30 17v13a1 1 0 0 1-1 1Zm-8-6h3a1 1 0 0 1 .625.22L28 27.92v-8.84l-3.376 2.7A1 1 0 0 1 24 22h-3Z" }), (0, import_jsx_runtime75.jsx)("path", { fill: "currentColor", d: "M16 28H8V4h8v6a2.006 2.006 0 0 0 2 2h6v3h2v-5a.91.91 0 0 0-.3-.7l-7-7A.909.909 0 0 0 18 2H8a2.006 2.006 0 0 0-2 2v24a2.006 2.006 0 0 0 2 2h8Zm2-23.6l5.6 5.6H18Z" })] });
};
var CarbonPauseFilled = (props) => {
  return (0, import_jsx_runtime75.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 32 32", role: "presentation", ...props, children: (0, import_jsx_runtime75.jsx)("path", { fill: "currentColor", d: "M12 6h-2a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2zm10 0h-2a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2z" }) });
};
var CarbonPlayFilledAlt = (props) => {
  return (0, import_jsx_runtime75.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 32 32", role: "presentation", ...props, children: (0, import_jsx_runtime75.jsx)("path", { fill: "currentColor", d: "M7 28a1 1 0 0 1-1-1V5a1 1 0 0 1 1.482-.876l20 11a1 1 0 0 1 0 1.752l-20 11A1 1 0 0 1 7 28Z" }) });
};
...
var MediaRenderer = (() => import_react45.default.forwardRef(function Media_Renderer({ src, poster, alt, gatewayUrl, requireInteraction = false, width = "300px", height = "300px", style, mimeType, client, controls, className }, ref) {
  ...
  if (!mediaInfoIsFetched || !src) {
    return (0, import_jsx_runtime76.jsx)("div", { style });
  }
  if (mediaInfo.mimeType) {
    if (mediaInfo.mimeType.startsWith("text/html")) {
      return (0, import_jsx_runtime76.jsx)(IframePlayer, { style: mergedStyle, src: mediaInfo.url, poster: possiblePosterSrc.url, ref, requireInteraction, className, alt });
    }
    if (mediaInfo.mimeType.startsWith("model")) {
      return (0, import_jsx_runtime76.jsx)(import_react45.Suspense, { fallback: poster ? (0, import_jsx_runtime76.jsx)("img", { style: mergedStyle, src: poster, alt, ref, className }) : null, children: (0, import_jsx_runtime76.jsx)(ModelViewer, { style: mergedStyle, src: mediaInfo.url || "", poster, alt, className }) });
    }
    if (mediaInfo.mimeType.startsWith("video")) {
      return (0, import_jsx_runtime76.jsx)(VideoPlayer, { style: mergedStyle, src: mediaInfo.url, ref, poster: ((_a = possiblePosterSrc.mimeType) == null ? void 0 : _a.startsWith("image/")) ? possiblePosterSrc.url : void 0, requireInteraction, className, controls });
    }
    if (mediaInfo.mimeType.startsWith("audio")) {
      return (0, import_jsx_runtime76.jsx)(AudioPlayer, { style: mergedStyle, src: mediaInfo.url, poster: possiblePosterSrc.url, alt, ref, className, height, width, controls });
    }
    if (mediaInfo.mimeType.startsWith("image/")) {
      return (0, import_jsx_runtime76.jsx)(ImageRenderer, { style: mergedStyle, src: mediaInfo.url, alt, ref, className, height, width });
    }
  }
  return (0, import_jsx_runtime76.jsx)(LinkPlayer, { style: mergedStyle, src: mediaInfo.url, alt, ref, className });
}))();
var ModelViewer = (0, import_react45.lazy)(() => import("./ModelViewer-47TPV7NZ.js"));
var PlayButton = ({ onClick, isPlaying }) => {
  ...
  return (0, import_jsx_runtime76.jsx)("button", { type: "button", style: {
    position: "absolute",
    bottom: 0,
    right: 0,
  ...
  }, onClick, onMouseEnter, onMouseLeave, onMouseDown, onMouseUp, children: !isPlaying ? (0, import_jsx_runtime76.jsx)(CarbonPlayFilledAlt, {}) : (0, import_jsx_runtime76.jsx)(CarbonPauseFilled, {}) });
};
var ImageRenderer = (() => import_react45.default.forwardRef(function Image_Renderer(props, ref) {
  ...
  if (error) {
    return (0, import_jsx_runtime76.jsx)(LinkPlayer, { style, src, alt, ref, className });
  }
  return (0, import_jsx_runtime76.jsx)("img", { style, src: src ?? void 0, alt, ref, className, height, width, onError: () => {
    setError(true);
  } });
}))();
var VideoPlayer = (() => import_react45.default.forwardRef(function Video_Player({ src, alt, poster, requireInteraction, style, width, height, controls, className }, ref) {
  ...
  return (0, import_jsx_runtime76.jsxs)("div", { style: { position: "relative", ...style }, className, children: [(0, import_jsx_runtime76.jsx)("video", { ref: mergeRefs2([videoRef, ref]), src: src ?? void 0, poster: poster ?? void 0, loop: true, playsInline: true, controlsList: "nodownload", muted, preload: poster ? "metadata" : "auto", onCanPlay: () => {
    var _a;
    if (playing) {
  ...
  } }), poster && (0, import_jsx_runtime76.jsx)("img", { src: poster, style: {
    objectFit: "contain",
    pointerEvents: "none",
    position: "absolute",
    width: "100%",
    ...
    right: 0,
    bottom: 0
  }, alt }), (0, import_jsx_runtime76.jsx)(PlayButton, { onClick: () => {
...
var AudioPlayer = (() => import_react45.default.forwardRef(function Audio_Player({ src, alt, poster, style, height, width, className, controls }, ref) {
  ...
  return (0, import_jsx_runtime76.jsxs)("div", { style: { position: "relative", ...style }, className, children: [poster ? (0, import_jsx_runtime76.jsx)("img", { height, width, src: poster, style: {
    height: "100%",
    width: "100%",
    pointerEvents: "none",
    objectFit: "contain"
  }, alt }) : (0, import_jsx_runtime76.jsx)("div", { style: {
    width: "100%",
    height: "100%",
    display: "grid",
    placeItems: "center",
    ...
    backgroundColor: "#fff",
    color: "rgb(138, 147, 155)"
  }, children: (0, import_jsx_runtime76.jsx)(CarbonDocumentAudio, { style: { height: "64px", width: "64px" } }) }), (0, import_jsx_runtime76.jsx)(PlayButton, { onClick: () => {
    setPlaying((prev) => !prev);
    setMuted(false);
  }, isPlaying: playing }), (0, import_jsx_runtime76.jsx)("audio", { ref: mergeRefs2([audioRef, ref]), src: src ?? void 0, loop: true, playsInline: true, controls, muted, preload: "none", controlsList: "nodownload", style: {
    position: "absolute",
    opacity: 0,
    pointerEvents: "none",
    zIndex: -1,
...
var IframePlayer = (() => import_react45.default.forwardRef(function Iframe_Player({ src, alt, poster, requireInteraction, style, ...restProps }, ref) {
  const [playing, setPlaying] = (0, import_react45.useState)(!requireInteraction);
  return (0, import_jsx_runtime76.jsxs)("div", { style: { position: "relative", ...style }, ...restProps, children: [(0, import_jsx_runtime76.jsx)("iframe", { title: alt || "thirdweb iframe player", src: playing ? src ?? void 0 : void 0, ref, style: {
    objectFit: "contain",
    zIndex: 1,
    height: "100%",
    width: "100%",
    ...
    opacity: !poster ? 1 : playing ? 1 : 0,
    border: "none"
  }, sandbox: "allow-scripts", allow: "accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" }), poster && (0, import_jsx_runtime76.jsx)("img", { src: poster, style: {
    objectFit: "contain",
    pointerEvents: "none",
    position: "absolute",
    width: "100%",
...
var LinkPlayer = (() => import_react45.default.forwardRef(function Link_Player({ src, alt, style, className }, ref) {
  return (0, import_jsx_runtime76.jsx)("div", { style: { position: "relative", ...style }, className, children: (0, import_jsx_runtime76.jsx)("div", { style: {
    width: "100%",
    height: "100%",
    display: "grid",
    placeItems: "center",
    ...
    alignItems: "center",
    flexWrap: "nowrap"
  }, children: [(0, import_jsx_runtime76.jsx)(CarbonDocumentUnknown, { style: {
    maxWidth: "128px",
    minWidth: "48px",
    width: "50%",
    aspectRatio: "1"
  } }), (0, import_jsx_runtime76.jsx)("a", { rel: "noopener noreferrer", style: {
...
function ViewNFTs(props) {
  return (0, import_jsx_runtime77.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime77.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime77.jsx)(ModalHeader, { title: props.connectLocale.viewFunds.viewNFTs, onBack: props.onBack }) }), (0, import_jsx_runtime77.jsx)(Line, {}), (0, import_jsx_runtime77.jsxs)(Container, { px: "sm", scrollY: true, style: {
    maxHeight: "500px"
  }, children: [(0, import_jsx_runtime77.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime77.jsx)(ViewNFTsContent, { ...props })] })] });
}
function ViewNFTsContent(props) {
  ...
  return (0, import_jsx_runtime77.jsxs)(import_jsx_runtime77.Fragment, { children: [(0, import_jsx_runtime77.jsx)(Container, { style: {
    display: "grid",
    gridTemplateColumns: "1fr 1fr",
    gap: "12px"
    ...
    return result.isLoading || !result.data ? (0, import_jsx_runtime77.jsx)(Skeleton, { height: "150px", width: "150px" }, `${(_b = (_a = nftList[index2]) == null ? void 0 : _a.chain) == null ? void 0 : _b.id}:${(_c = nftList[index2]) == null ? void 0 : _c.address}`) : result.data.map((nft) => (0, import_jsx_runtime77.jsx)(NftCard, { ...nft, client: props.client, chain: nft.chain, theme: props.theme }, `${nft.chain.id}:${nft.address}:${nft.id}`));
  }) }), (0, import_jsx_runtime77.jsx)(Spacer, { y: "lg" })] });
}
function NftCard(props) {
  ...
  const content = (0, import_jsx_runtime77.jsxs)("div", { style: {
    display: "flex",
    flexDirection: "column",
    gap: "4px",
    alignItems: "center"
  }, children: [(0, import_jsx_runtime77.jsxs)("div", { style: {
    position: "relative",
    display: "flex",
    flexShrink: 0,
    alignItems: "center",
  ...
  }, children: [props.metadata.image && (0, import_jsx_runtime77.jsx)(MediaRenderer, { src: props.metadata.image, style: {
    width: "100%",
    height: "100%"
  }, client: props.client }), props.quantityOwned > 1 && (0, import_jsx_runtime77.jsx)("div", { style: {
    position: "absolute",
    bottom: "4px",
    right: "4px",
    ...
    justifyContent: "center",
    borderRadius: "100%"
  }, children: props.quantityOwned.toString() }), props.chain.icon && (0, import_jsx_runtime77.jsx)("img", { alt: props.chain.name, style: {
    position: "absolute",
    bottom: "4px",
    left: "4px",
    width: "20px",
    height: "20px"
  }, src: props.chain.icon.url })] }), (0, import_jsx_runtime77.jsx)("span", { style: { fontWeight: 600 }, children: props.metadata.name })] });
  if (props.chain.name) {
    return (0, import_jsx_runtime77.jsx)("a", { href: `https://thirdweb.com/${props.chain.id}/${props.address}/nfts/${props.id}`, target: "_blank", rel: "noreferrer", children: content });
  }
  return content;
}
...
function ViewTokens(props) {
  return (0, import_jsx_runtime78.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime78.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime78.jsx)(ModalHeader, { title: props.connectLocale.viewFunds.title, onBack: props.onBack }) }), (0, import_jsx_runtime78.jsx)(Line, {}), (0, import_jsx_runtime78.jsxs)(Container, { px: "sm", scrollY: true, style: {
    maxHeight: "500px"
  }, children: [(0, import_jsx_runtime78.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime78.jsx)(ViewTokensContent, { ...props }), (0, import_jsx_runtime78.jsx)(Spacer, { y: "lg" })] })] });
}
function ViewTokensContent(props) {
  ...
  return (0, import_jsx_runtime78.jsxs)(import_jsx_runtime78.Fragment, { children: [(0, import_jsx_runtime78.jsx)(TokenInfo, { token: NATIVE_TOKEN, chain: activeChain, client: props.client }), tokenList.map((token) => {
    return (0, import_jsx_runtime78.jsx)(TokenInfo, { token, chain: activeChain, client: props.client }, token.address);
  })] });
}
function TokenInfo(props) {
  ...
  return (0, import_jsx_runtime78.jsxs)(Container, { flex: "row", gap: "sm", p: "sm", children: [(0, import_jsx_runtime78.jsx)(TokenIcon, { token: props.token, chain: props.chain, size: "lg", client: props.client }), (0, import_jsx_runtime78.jsxs)(Container, { flex: "column", gap: "xxs", children: [tokenName ? (0, import_jsx_runtime78.jsx)(Text, { size: "sm", color: "primaryText", children: tokenName }) : (0, import_jsx_runtime78.jsx)(Skeleton, { height: fontSize.md, width: "150px" }), tokenBalanceQuery.data ? (0, import_jsx_runtime78.jsxs)(Text, { size: "xs", children: [" ", formatTokenBalance(tokenBalanceQuery.data)] }) : (0, import_jsx_runtime78.jsx)(Skeleton, { height: fontSize.xs, width: "100px" })] })] });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/ViewAssets.js
function ViewAssets(props) {
  const [activeTab, setActiveTab] = (0, import_react47.useState)("Tokens");
  const { connectLocale } = props;
  return (0, import_jsx_runtime79.jsxs)(Container, { animate: "fadein", style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime79.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime79.jsx)(ModalHeader, { title: connectLocale.viewFunds.title, onBack: props.onBack }) }), (0, import_jsx_runtime79.jsx)(Line, {}), (0, import_jsx_runtime79.jsxs)(Container, { px: "lg", scrollY: true, style: {
    minHeight: "330px"
  }, children: [(0, import_jsx_runtime79.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime79.jsx)(Tabs, { options: [
    {
      label: (0, import_jsx_runtime79.jsxs)("span", { className: "flex gap-2", children: [(0, import_jsx_runtime79.jsx)(CoinsIcon, { size: iconSize.sm }), " Tokens"] }),
      value: "Tokens"
    },
    {
      label: (0, import_jsx_runtime79.jsxs)("span", { className: "flex gap-2", children: [(0, import_jsx_runtime79.jsx)(ImageIcon, { size: iconSize.sm }), " NFTs"] }),
      value: "NFTs"
    }
  ], selected: activeTab, onSelect: setActiveTab, children: (0, import_jsx_runtime79.jsxs)(Container, { scrollY: true, style: {
    maxHeight: "300px"
  }, children: [activeTab === "Tokens" && (0, import_jsx_runtime79.jsx)(ViewTokensContent, { client: props.client, connectLocale, supportedTokens: props.supportedTokens }), activeTab === "NFTs" && (0, import_jsx_runtime79.jsx)(ViewNFTsContent, { supportedNFTs: props.supportedNFTs, client: props.client, theme: props.theme, connectLocale })] }) }), (0, import_jsx_runtime79.jsx)(Spacer, { y: "lg" })] })] });
}
...
function WalletConnectDisconnectScreen(props) {
  return (0, import_jsx_runtime80.jsxs)(Container, { style: {
    ...
    maxHeight: "500px"
  }, children: (0, import_jsx_runtime80.jsxs)(Container, { py: "lg", style: { position: "relative" }, children: [(0, import_jsx_runtime80.jsx)(Container, { py: "md", children: (0, import_jsx_runtime80.jsx)(WalletLogoSpinner, { client: props.client, error: !!props.error, id: "walletConnect", hideSpinner: true }) }), (0, import_jsx_runtime80.jsx)(Container, { animate: "fadein", style: {
    animationDuration: "200ms"
  }, children: !props.error ? (0, import_jsx_runtime80.jsxs)(import_jsx_runtime80.Fragment, { children: [(0, import_jsx_runtime80.jsxs)(Text, { balance: true, center: true, multiline: true, size: "md", children: ["Connected to ", props.session.origin ?? "another app."] }), (0, import_jsx_runtime80.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime80.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    props.disconnect();
  }, children: "Disconnect" })] }) : (0, import_jsx_runtime80.jsxs)(import_jsx_runtime80.Fragment, { children: [(0, import_jsx_runtime80.jsx)(Text, { center: true, balance: true, multiline: true, size: "sm", children: props.error }), (0, import_jsx_runtime80.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime80.jsx)(Container, { flex: "row", center: "x", animate: "fadein", children: (0, import_jsx_runtime80.jsxs)(Button, { fullWidth: true, variant: "accent", onClick: () => props.disconnect(), style: {
    gap: spacing.xs,
    alignItems: "center"
  }, children: [(0, import_jsx_runtime80.jsx)(ReloadIcon, { width: iconSize.sm, height: iconSize.sm }), "Retry"] }) })] }) })] }) })] });
}
...
function WalletConnectReceiverScreen(props) {
  ...
  if (session) {
    return (0, import_jsx_runtime81.jsx)(WalletConnectDisconnectScreen, { disconnect, error: errorConnecting, ...props, session });
  }
  return (0, import_jsx_runtime81.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime81.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime81.jsx)(ModalHeader, { title: "Connect an App", onBack: props.onBack }) }), (0, import_jsx_runtime81.jsx)(Line, {}), (0, import_jsx_runtime81.jsx)(Container, { px: "lg", scrollY: true, style: {
    maxHeight: "500px"
  }, children: (0, import_jsx_runtime81.jsxs)(Container, { py: "sm", style: { position: "relative" }, children: [(0, import_jsx_runtime81.jsx)(Container, { py: "md", children: (0, import_jsx_runtime81.jsx)(WalletLogoSpinner, { client: props.client, error: !!errorConnecting, id: "walletConnect", hideSpinner: !loading }) }), (0, import_jsx_runtime81.jsx)(Container, { animate: "fadein", style: {
    animationDuration: "200ms"
  }, children: !errorConnecting ? (0, import_jsx_runtime81.jsxs)(import_jsx_runtime81.Fragment, { children: [(0, import_jsx_runtime81.jsx)(Text, { balance: true, center: true, multiline: true, size: "sm", children: "Copy your connection URI from the external app." }), (0, import_jsx_runtime81.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime81.jsx)(InputSelectionUI, { type: "text", disabled: loading || !!errorConnecting || !walletConnectClient, onSelect: async (value) => {
    setLoading(true);
    if (!walletConnectClient) {
  ...
  }, placeholder: "WalletConnect URI", name: "wcUri", emptyErrorMessage: "Please enter a valid URI", submitButtonText: "Connect" })] }) : (0, import_jsx_runtime81.jsxs)(import_jsx_runtime81.Fragment, { children: [(0, import_jsx_runtime81.jsx)(Text, { center: true, balance: true, multiline: true, size: "sm", children: errorConnecting }), (0, import_jsx_runtime81.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime81.jsx)(Container, { flex: "row", center: "x", animate: "fadein", children: (0, import_jsx_runtime81.jsxs)(Button, { fullWidth: true, variant: "accent", onClick: () => setErrorConnecting(false), style: {
    gap: spacing.xs,
    alignItems: "center"
  }, children: [(0, import_jsx_runtime81.jsx)(ReloadIcon, { width: iconSize.sm, height: iconSize.sm }), "Retry"] }) })] }) })] }) }), (0, import_jsx_runtime81.jsxs)(Container, { children: [(0, import_jsx_runtime81.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime81.jsx)(Line, {}), (0, import_jsx_runtime81.jsx)(Container, { flex: "row", center: "x", p: "lg", children: (0, import_jsx_runtime81.jsx)("a", { href: "https://blog.thirdweb.com/p/a62c0ef4-1d8f-424d-95b9-a006e5239849/", children: (0, import_jsx_runtime81.jsx)(Button, { variant: "link", onClick: () => {
...
var ConnectedWalletDetails = (props) => {
  ...
  function openModal() {
    var _a2;
    setRootEl((0, import_jsx_runtime82.jsx)(DetailsModal, { client, locale, detailsModal: props.detailsModal, theme: props.theme, supportedTokens: props.supportedTokens, supportedNFTs: props.supportedNFTs, closeModal, onDisconnect: props.onDisconnect, chains: props.chains, displayBalanceToken: (_a2 = props.detailsButton) == null ? void 0 : _a2.displayBalanceToken, connectOptions: props.connectOptions }));
  }
  ...
  if ((_b = props.detailsButton) == null ? void 0 : _b.render) {
    return (
      ...
      (0, import_jsx_runtime82.jsx)("div", { onClick: openModal, children: (0, import_jsx_runtime82.jsx)(props.detailsButton.render, {}) })
    );
  }
  if (props.chain && isNetworkMismatch) {
    return (0, import_jsx_runtime82.jsx)(SwitchNetworkButton2, { style: (_c = props.switchButton) == null ? void 0 : _c.style, className: (_d = props.switchButton) == null ? void 0 : _d.className, switchNetworkBtnTitle: (_e = props.switchButton) == null ? void 0 : _e.label, targetChain: props.chain, connectLocale: locale });
  }
  ...
  return (0, import_jsx_runtime82.jsxs)(WalletInfoButton, { type: "button", className: combinedClassName, style: (_h = props.detailsButton) == null ? void 0 : _h.style, "data-test": "connected-wallet-details", onClick: openModal, children: [(0, import_jsx_runtime82.jsx)(Container, { style: {
    borderRadius: "100%",
    overflow: "hidden",
    width: "35px",
    height: "35px"
  }, children: avatarSrc ? (0, import_jsx_runtime82.jsx)("img", { alt: "", src: avatarSrc, style: {
    width: "100%",
    height: "100%"
  } }) : activeAccount && (0, import_jsx_runtime82.jsx)(Blobbie, { address: activeAccount.address, size: 35 }) }), (0, import_jsx_runtime82.jsxs)(Container, { flex: "column", gap: "4xs", style: {
    textOverflow: "ellipsis",
    whiteSpace: "nowrap",
    borderRadius: `0 ${radius.md} ${radius.md} 0`
  }, children: [(0, import_jsx_runtime82.jsx)(Text, { size: "xs", color: "primaryText", weight: 500, className: `${TW_CONNECTED_WALLET}__address`, children: ((_i = props.detailsButton) == null ? void 0 : _i.connectedAccountName) ?? name }), balanceQuery.data ? (0, import_jsx_runtime82.jsxs)(Text, { className: `${TW_CONNECTED_WALLET}__balance`, size: "xs", color: "secondaryText", weight: 400, children: [formatBalanceOnButton(Number(balanceQuery.data.displayValue)), " ", balanceQuery.data.symbol] }) : (0, import_jsx_runtime82.jsx)(Skeleton, { height: fontSize.xs, width: "70px" })] })] });
};
function DetailsModal(props) {
  ...
  const networkSwitcherButton = (0, import_jsx_runtime82.jsxs)(MenuButton, { type: "button", disabled: disableSwitchChain, onClick: () => {
    setScreen("network-switcher");
  }, "data-variant": "primary", children: [(0, import_jsx_runtime82.jsx)("div", { style: {
    display: "flex",
    alignItems: "center",
    position: "relative"
  }, children: !chainIconQuery.isLoading ? (0, import_jsx_runtime82.jsx)(ChainIcon, { chainIconUrl: chainIconQuery.url, size: iconSize.md, active: true, client }) : (0, import_jsx_runtime82.jsx)(Skeleton, { height: `${iconSize.md}px`, width: `${iconSize.md}px` }) }), chainNameQuery.isLoading ? (0, import_jsx_runtime82.jsx)(Skeleton, { height: "16px", width: "150px" }) : (0, import_jsx_runtime82.jsxs)(Text, { color: "primaryText", size: "md", multiline: true, children: [chainNameQuery.name || `Unknown chain #${walletChain == null ? void 0 : walletChain.id}`, (0, import_jsx_runtime82.jsxs)(Text, { color: "secondaryText", size: "xs", children: [balanceQuery.data ? formatNumber(Number(balanceQuery.data.displayValue), 5) : (0, import_jsx_runtime82.jsx)(Skeleton, { height: "1em", width: "100px" }), " ", (_a = balanceQuery.data) == null ? void 0 : _a.symbol] })] }), (0, import_jsx_runtime82.jsx)(StyledChevronRightIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    flexShrink: 0,
    marginLeft: "auto"
  } })] });
  ...
  const avatarContent = (0, import_jsx_runtime82.jsxs)(Container, { style: {
    position: "relative",
    height: `${iconSize.xl}px`,
    width: `${iconSize.xl}px`
  }, children: [(0, import_jsx_runtime82.jsx)(Container, { style: {
    width: "100%",
    height: "100%",
    borderRadius: "100%",
    overflow: "hidden"
  }, children: avatarSrc ? (0, import_jsx_runtime82.jsx)("img", { src: avatarSrc, style: {
    width: iconSize.xxl,
    height: iconSize.xxl
  }, alt: "" }) : activeAccount && (0, import_jsx_runtime82.jsx)(Blobbie, { address: activeAccount.address, size: Number(iconSize.xxl) }) }), !((_c = props.detailsModal) == null ? void 0 : _c.hideSwitchWallet) ? (0, import_jsx_runtime82.jsx)(Container, { style: {
    position: "absolute",
    bottom: -2,
    right: -2
  }, children: (0, import_jsx_runtime82.jsx)(IconContainer, { style: {
    background: theme.colors.modalBg
  }, padding: "4px", children: activeWallet && (0, import_jsx_runtime82.jsx)(WalletImage, { style: { borderRadius: 0 }, id: activeWallet.id, client, size: "12" }) }) }) : null] });
  let content = (0, import_jsx_runtime82.jsxs)("div", { children: [(0, import_jsx_runtime82.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime82.jsxs)(Container, { px: "lg", gap: "sm", flex: "row", center: "y", style: {
    paddingTop: spacing.lg,
    paddingBottom: hideAllButtons ? spacing.md : spacing.lg
  }, children: [((_d = props.detailsModal) == null ? void 0 : _d.hideSwitchWallet) ? avatarContent : (0, import_jsx_runtime82.jsx)(ToolTip, { tip: "Switch wallet", children: (0, import_jsx_runtime82.jsx)("div", { style: {
    cursor: "pointer"
  }, onKeyDown: (e) => {
    if (e.key === "w") {
    ...
    setScreen("wallet-manager");
  }, children: avatarContent }) }), (0, import_jsx_runtime82.jsxs)(Container, { flex: "column", gap: "3xs", children: [(0, import_jsx_runtime82.jsxs)("div", { style: {
    display: "flex",
    gap: spacing.xxs,
    alignItems: "center"
  }, children: [(0, import_jsx_runtime82.jsx)(Text, { color: "primaryText", weight: 500, size: "md", children: ((_e = props.detailsModal) == null ? void 0 : _e.connectedAccountName) ?? name }), (0, import_jsx_runtime82.jsx)(IconButton, { children: (0, import_jsx_runtime82.jsx)(CopyIcon2, { text: (activeAccount == null ? void 0 : activeAccount.address) || "", tip: locale.copyAddress }) })] }), (0, import_jsx_runtime82.jsx)(InAppWalletUserInfo, { client, locale })] })] }), !hideAllButtons && (0, import_jsx_runtime82.jsxs)(import_jsx_runtime82.Fragment, { children: [(0, import_jsx_runtime82.jsx)(Container, { px: "lg", children: (0, import_jsx_runtime82.jsxs)(Container, { style: {
    display: "flex",
    gap: spacing.xs
  }, children: [!hideSendFunds && (0, import_jsx_runtime82.jsxs)(Button, { variant: "outline", style: {
    fontSize: fontSize.sm,
    display: "flex",
    gap: spacing.xs,
    alignItems: "center",
    ...
    setScreen("send");
  }, children: [(0, import_jsx_runtime82.jsx)(Container, { color: "secondaryText", flex: "row", center: "both", children: (0, import_jsx_runtime82.jsx)(PaperPlaneIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    transform: "translateY(-10%) rotate(-45deg) "
  } }) }), locale.send] }), !hideReceiveFunds && (0, import_jsx_runtime82.jsxs)(Button, { variant: "outline", style: {
    fontSize: fontSize.sm,
    display: "flex",
    gap: spacing.xs,
    alignItems: "center",
    ...
    setScreen("receive");
  }, children: [(0, import_jsx_runtime82.jsx)(Container, { color: "secondaryText", flex: "row", center: "both", children: (0, import_jsx_runtime82.jsx)(PinBottomIcon, { width: iconSize.sm, height: iconSize.sm }) }), locale.receive] }), !hideBuyFunds && (0, import_jsx_runtime82.jsxs)(Button, { variant: "outline", style: {
    fontSize: fontSize.sm,
    display: "flex",
    gap: spacing.xs,
    alignItems: "center",
    ...
    setScreen("buy");
  }, children: [(0, import_jsx_runtime82.jsx)(Container, { color: "secondaryText", flex: "row", center: "both", children: (0, import_jsx_runtime82.jsx)(PlusIcon, { width: iconSize.sm, height: iconSize.sm }) }), locale.buy] })] }) }), (0, import_jsx_runtime82.jsx)(Spacer, { y: "md" })] }), (0, import_jsx_runtime82.jsxs)(Container, { px: "md", children: [(0, import_jsx_runtime82.jsxs)(Container, { flex: "column", style: {
    gap: "1px"
  }, children: [networkSwitcherButton, (0, import_jsx_runtime82.jsxs)(MenuButton, { onClick: () => {
    setScreen("transactions");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime82.jsx)(TextAlignJustifyIcon, { width: iconSize.md, height: iconSize.md }), (0, import_jsx_runtime82.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime82.jsx)(Text, { color: "primaryText", children: locale.transactions }) })] }), (0, import_jsx_runtime82.jsxs)(MenuButton, { onClick: () => {
    setScreen("view-assets");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime82.jsx)(CoinsIcon, { size: iconSize.md }), (0, import_jsx_runtime82.jsx)(Text, { color: "primaryText", children: props.supportedNFTs ? locale.viewFunds.viewAssets : locale.viewFunds.title })] }), (0, import_jsx_runtime82.jsxs)(MenuButton, { onClick: () => {
    setScreen("manage-wallet");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime82.jsx)(OutlineWalletIcon, { size: iconSize.md }), (0, import_jsx_runtime82.jsx)(Text, { color: "primaryText", children: props.locale.manageWallet.title })] }), (((_f = props.detailsModal) == null ? void 0 : _f.showTestnetFaucet) ?? false) && (chainFaucetsQuery.faucets.length > 0 || (walletChain == null ? void 0 : walletChain.id) === LocalhostChainId) && (0, import_jsx_runtime82.jsxs)(MenuLink, { href: chainFaucetsQuery.faucets ? chainFaucetsQuery.faucets[0] : "#", target: "_blank", as: "a", style: {
    textDecoration: "none",
    color: "inherit"
  }, children: [(0, import_jsx_runtime82.jsx)(Container, { flex: "row", center: "both", color: "secondaryText", children: (0, import_jsx_runtime82.jsx)(FundsIcon, { size: iconSize.md }) }), locale.requestTestnetFunds] }), ((_g = props.detailsModal) == null ? void 0 : _g.footer) && (0, import_jsx_runtime82.jsx)(props.detailsModal.footer, { close: closeModal })] }), (0, import_jsx_runtime82.jsx)(Spacer, { y: "md" })] }), ((_h = props.detailsModal) == null ? void 0 : _h.hideDisconnect) !== true && (0, import_jsx_runtime82.jsxs)(Container, { children: [(0, import_jsx_runtime82.jsx)(Line, {}), (0, import_jsx_runtime82.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime82.jsx)(Container, { px: "md", children: (0, import_jsx_runtime82.jsxs)(MenuButton, { "data-variant": "danger", type: "button", onClick: () => {
  ...
  if (screen === "network-switcher") {
    ...
    if (props.supportedNFTs) {
      content = (0, import_jsx_runtime82.jsx)(ViewAssets, { supportedTokens: props.supportedTokens, supportedNFTs: props.supportedNFTs, onBack: () => {
        setScreen("main");
      }, theme: props.theme, setScreen, client, connectLocale: locale });
    } else {
      content = (0, import_jsx_runtime82.jsx)(ViewTokens, { supportedTokens: props.supportedTokens, onBack: () => {
        setScreen("main");
      }, client, connectLocale: locale });
    }
  } else if (screen === "view-nfts") {
    content = (0, import_jsx_runtime82.jsx)(ViewNFTs, { theme: props.theme, supportedNFTs: props.supportedNFTs, onBack: () => {
      setScreen("main");
    }, client, connectLocale: locale });
    ...
    content = (0, import_jsx_runtime82.jsx)(PrivateKey, { theme: props.theme, onBack: () => {
      setScreen("manage-wallet");
    }, wallet: activeWallet, client });
  } else if (screen === "manage-wallet") {
    content = (0, import_jsx_runtime82.jsx)(ManageWalletScreen, { onBack: () => {
      setScreen("main");
    }, locale, closeModal, client, setScreen });
  } else if (screen === "wallet-connect-receiver") {
    content = (0, import_jsx_runtime82.jsx)(WalletConnectReceiverScreen, { onBack: () => {
      setScreen("manage-wallet");
    }, chains: props.chains, client });
  } else if (screen === "linked-profiles") {
    content = (0, import_jsx_runtime82.jsx)(LinkedProfilesScreen, { onBack: () => setScreen("manage-wallet"), client, locale, setScreen });
  } else if (screen === "link-profile") {
    content = (0, import_jsx_runtime82.jsx)(LinkProfileScreen, { onBack: () => {
      setScreen("linked-profiles");
    }, client, locale, walletConnect: (_s = props.connectOptions) == null ? void 0 : _s.walletConnect });
  } else if (screen === "send") {
    content = (0, import_jsx_runtime82.jsx)(SendFunds, { supportedTokens: props.supportedTokens, onBack: () => {
      setScreen("main");
    }, client, connectLocale: locale });
  } else if (screen === "receive") {
    content = (0, import_jsx_runtime82.jsx)(ReceiveFunds, { walletId: activeWallet == null ? void 0 : activeWallet.id, onBack: () => {
      setScreen("main");
    }, client, connectLocale: locale });
  } else if (screen === "buy") {
    content = (0, import_jsx_runtime82.jsx)(LazyBuyScreen, { title: locale.buy, isEmbed: false, client, onBack: () => setScreen("main"), supportedTokens: props.supportedTokens, connectLocale: locale, payOptions: ((_t = props.detailsModal) == null ? void 0 : _t.payOptions) || {
      mode: "fund_wallet"
    }, hiddenWallets: (_u = props.detailsModal) == null ? void 0 : _u.hiddenWallets, theme: typeof props.theme === "string" ? props.theme : props.theme.type, onDone: closeModal, connectOptions: void 0 });
  }
  return (0, import_jsx_runtime82.jsx)(CustomThemeProvider, { theme: props.theme, children: (0, import_jsx_runtime82.jsx)(WalletUIStatesProvider, { theme: props.theme, isOpen: false, children: (0, import_jsx_runtime82.jsx)(ScreenSetupContext.Provider, { value: screenSetup, children: (0, import_jsx_runtime82.jsx)(Modal, { size: "compact", open: isOpen, setOpen: (_open) => {
    if (!_open) {
      closeModal();
    }
  }, children: content }) }) }) });
...
function ConnectedToSmartWallet(props) {
  ...
  const content = (0, import_jsx_runtime82.jsx)(Container, { flex: "row", gap: "3xs", center: "y", children: (0, import_jsx_runtime82.jsx)(Text, { size: "xs", weight: 400, color: "secondaryText", children: locale.connectedToSmartWallet }) });
  if (chain && activeAccount && isSmartWallet) {
    return (0, import_jsx_runtime82.jsx)(import_jsx_runtime82.Fragment, { children: isSmartWalletDeployed ? (0, import_jsx_runtime82.jsx)(Link, { color: "secondaryText", hoverColor: "primaryText", href: `https://thirdweb.com/${chain.id}/${activeAccount.address}/account`, target: "_blank", size: "sm", children: content }) : (0, import_jsx_runtime82.jsxs)(Text, { size: "sm", children: [" ", content] }) });
  }
  return null;
}
function InAppWalletUserInfo(props) {
  ...
  const userInfoQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      const { getUserEmail, getUserPhoneNumber } = await import("./auth-6OG5QYFW.js");
  ...
  if (!userInfoQuery.data && isSmartWallet) {
    return (0, import_jsx_runtime82.jsx)(ConnectedToSmartWallet, { client, connectLocale: locale });
  }
  if (userInfoQuery.data || walletName) {
    return (0, import_jsx_runtime82.jsx)(Text, { size: "xs", weight: 400, children: userInfoQuery.data || walletName });
  }
  return (0, import_jsx_runtime82.jsx)(Skeleton, { width: "50px", height: "10px" });
}
function SwitchNetworkButton2(props) {
  ...
  return (0, import_jsx_runtime82.jsx)(Button, { className: `tw-connect-wallet--switch-network ${props.className || ""}`, variant: "primary", type: "button", "data-is-loading": switching, "data-test": "switch-network-button", disabled: switching, onClick: async () => {
    setSwitching(true);
    try {
    ...
    minWidth: "140px",
    ...props.style
  }, "aria-label": switching ? locale.switchingNetwork : void 0, children: switching ? (0, import_jsx_runtime82.jsx)(Spinner, { size: "sm", color: "primaryButtonText" }) : switchNetworkBtnTitle });
}
function useWalletDetailsModal() {
  ...
  function openModal(props) {
    ...
    getConnectLocale(props.locale || "en_US").then((locale) => {
      setRootEl((0, import_jsx_runtime82.jsx)(DetailsModal, { client: props.client, locale, detailsModal: {
        footer: props.footer,
...
var ConnectModal = (props) => {
  ...
  return (0, import_jsx_runtime83.jsx)(Modal, { hide: hideModal, size: props.size, open: isWalletModalOpen, setOpen: (value) => {
    if (hideModal) {
      return;
    }
    if (!value) {
...
var LockIcon = (props) => {
  return (0, import_jsx_runtime84.jsx)("svg", { width: props.size, height: props.size, viewBox: "0 0 16 21", fill: "none", xmlns: "http://www.w3.org/2000/svg", role: "presentation", children: (0, import_jsx_runtime84.jsx)("path", { d: "M2 21C1.45 21 0.979333 20.8043 0.588 20.413C0.196 20.021 0 19.55 0 19V9C0 8.45 0.196 7.979 0.588 7.587C0.979333 7.19567 1.45 7 2 7H3V5C3 3.61667 3.48767 2.43733 4.463 1.462C5.43767 0.487333 6.61667 0 8 0C9.38333 0 10.5627 0.487333 11.538 1.462C12.5127 2.43733 13 3.61667 13 5V7H14C14.55 7 15.021 7.19567 15.413 7.587C15.8043 7.979 16 8.45 16 9V19C16 19.55 15.8043 20.021 15.413 20.413C15.021 20.8043 14.55 21 14 21H2ZM8 16C8.55 16 9.021 15.8043 9.413 15.413C9.80433 15.021 10 14.55 10 14C10 13.45 9.80433 12.979 9.413 12.587C9.021 12.1957 8.55 12 8 12C7.45 12 6.97933 12.1957 6.588 12.587C6.196 12.979 6 13.45 6 14C6 14.55 6.196 15.021 6.588 15.413C6.97933 15.8043 7.45 16 8 16ZM5 7H11V5C11 4.16667 10.7083 3.45833 10.125 2.875C9.54167 2.29167 8.83333 2 8 2C7.16667 2 6.45833 2.29167 5.875 2.875C5.29167 3.45833 5 4.16667 5 5V7Z", fill: "currentColor" }) });
};
...
function ConnectButton(props) {
  ...
  const autoConnectComp = props.autoConnect !== false && (0, import_jsx_runtime85.jsx)(AutoConnect, { chain: preferredChain, appMetadata: props.appMetadata, client: props.client, wallets, timeout: typeof props.autoConnect === "boolean" ? void 0 : (_d = props.autoConnect) == null ? void 0 : _d.timeout, accountAbstraction: props.accountAbstraction, onConnect: props.onConnect });
  if (!localeQuery.data) {
    const combinedClassName = `${((_e = props.connectButton) == null ? void 0 : _e.className) || ""} ${TW_CONNECT_WALLET}`;
    return (0, import_jsx_runtime85.jsxs)(AnimatedButton, { disabled: true, className: combinedClassName, variant: "primary", type: "button", style: {
      minWidth: "165px",
      height: "50px",
      ...(_f = props.connectButton) == null ? void 0 : _f.style
    }, children: [autoConnectComp, (0, import_jsx_runtime85.jsx)(Spinner, { size: "sm", color: "primaryButtonText" })] });
  }
  return (0, import_jsx_runtime85.jsxs)(WalletUIStatesProvider, { theme: props.theme, isOpen: false, children: [(0, import_jsx_runtime85.jsx)(ConnectButtonInner, { ...props, connectLocale: localeQuery.data }), (0, import_jsx_runtime85.jsx)(ConnectModal_default, { shouldSetActive: true, accountAbstraction: props.accountAbstraction, auth: props.auth, chain: preferredChain, chains: props.chains, client: props.client, connectLocale: localeQuery.data, meta: {
...
function ConnectButtonInner(props) {
  ...
  if (!activeAccount) {
    ...
    return (0, import_jsx_runtime85.jsx)(AnimatedButton, { disabled: isLoading, className: combinedClassName, "data-theme": theme, "data-is-loading": isLoading, variant: "primary", type: "button", style: {
      minWidth: "165px",
      height: "50px",
      fontSize: "16px",
    ...
    }, "data-test": "connect-wallet-button", children: isLoading ? (0, import_jsx_runtime85.jsx)(Spinner, { size: "sm", color: "primaryButtonText" }) : connectButtonLabel });
  }
  if (siweAuth.requiresAuth) {
    if (siweAuth.isLoading || siweAuth.isLoggingIn || siweAuth.isLoggingOut) {
      ...
      return (0, import_jsx_runtime85.jsx)(AnimatedButton, { disabled: true, className: combinedClassName, variant: "primary", type: "button", style: {
        minWidth: "165px",
        height: "50px",
        ...(_e = props.connectButton) == null ? void 0 : _e.style
      }, children: (0, import_jsx_runtime85.jsx)(Spinner, { size: "sm", color: "primaryButtonText" }) });
    }
    if (!siweAuth.isLoggedIn) {
      return (0, import_jsx_runtime85.jsxs)(import_jsx_runtime85.Fragment, { children: [(0, import_jsx_runtime85.jsx)(Button, { variant: "primary", type: "button", onClick: () => {
        setShowSignatureModal(true);
      }, className: (_f = props.signInButton) == null ? void 0 : _f.className, style: {
        minWidth: "165px",
        minHeight: "50px",
        ...(_g = props.signInButton) == null ? void 0 : _g.style
      }, children: siweAuth.isLoggingIn ? (0, import_jsx_runtime85.jsx)(Spinner, { size: "sm", color: "primaryButtonText" }) : (0, import_jsx_runtime85.jsxs)(Container, { flex: "row", center: "y", gap: "sm", children: [(0, import_jsx_runtime85.jsx)(LockIcon, { size: iconSize.sm }), (0, import_jsx_runtime85.jsxs)("span", { children: [" ", ((_h = props.signInButton) == null ? void 0 : _h.label) || locale.signIn, " "] })] }) }), (0, import_jsx_runtime85.jsx)(Modal, { size: "compact", open: showSignatureModal, setOpen: setShowSignatureModal, children: (0, import_jsx_runtime85.jsx)(SignatureScreen, { client: props.client, connectLocale: locale, modalSize: "compact", termsOfServiceUrl: (_i = props.connectModal) == null ? void 0 : _i.termsOfServiceUrl, privacyPolicyUrl: (_j = props.connectModal) == null ? void 0 : _j.privacyPolicyUrl, onDone: () => setShowSignatureModal(false), auth: props.auth }) })] });
    }
  }
  return (0, import_jsx_runtime85.jsx)(ConnectedWalletDetails, { theme, detailsButton: props.detailsButton, detailsModal: props.detailsModal, supportedTokens, supportedNFTs: props.supportedNFTs, onDisconnect: (info) => {
    var _a2;
    if (siweAuth.requiresAuth) {
      siweAuth.doLogout();
    }
...
function DirectPaymentModeScreen(props) {
  ...
  if (!chainData || totalCost === void 0) {
    return (0, import_jsx_runtime86.jsx)(LoadingScreen, {});
  }
  ...
  return (0, import_jsx_runtime86.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime86.jsx)(ModalHeader, { title: (metadata == null ? void 0 : metadata.name) || "Payment Details" }), (0, import_jsx_runtime86.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime86.jsxs)(Container, { children: [(metadata == null ? void 0 : metadata.image) ? (0, import_jsx_runtime86.jsx)(Img, { client, src: metadata == null ? void 0 : metadata.image, style: {
    width: "100%",
    borderRadius: spacing.md,
    backgroundColor: theme.colors.tertiaryBg
  } }) : activeWallet ? (0, import_jsx_runtime86.jsxs)(Container, { flex: "row", center: "both", style: {
    padding: spacing.md,
    marginBottom: spacing.md,
    borderRadius: spacing.md,
    backgroundColor: theme.colors.tertiaryBg
  }, children: [(0, import_jsx_runtime86.jsx)(WalletImage, { size: iconSize.xl, id: activeWallet.id, client }), (0, import_jsx_runtime86.jsx)("div", { style: {
    flexGrow: 1,
    borderBottom: "6px dotted",
    borderColor: theme.colors.secondaryIconColor,
    marginLeft: spacing.md,
    marginRight: spacing.md
  } }), (0, import_jsx_runtime86.jsx)(ChainIcon, { client, size: iconSize.xl, chainIconUrl: (_e = chainData.icon) == null ? void 0 : _e.url })] }) : null, (0, import_jsx_runtime86.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime86.jsxs)(Container, { flex: "row", children: [(0, import_jsx_runtime86.jsx)(Container, { flex: "column", expand: true, children: (0, import_jsx_runtime86.jsx)(Text, { size: "md", color: "primaryText", weight: 700, children: "Price" }) }), (0, import_jsx_runtime86.jsx)(Container, { expand: true, children: (0, import_jsx_runtime86.jsxs)(Container, { flex: "row", gap: "xs", center: "y", style: { justifyContent: "right" }, children: [(0, import_jsx_runtime86.jsx)(TokenIcon, { chain: paymentInfo.chain, client: props.client, size: "sm", token }), (0, import_jsx_runtime86.jsxs)(Text, { color: "primaryText", size: "md", weight: 700, children: [String(formatNumber(Number(totalCost), 6)), " ", token.symbol] })] }) })] }), (0, import_jsx_runtime86.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime86.jsx)(Line, {}), (0, import_jsx_runtime86.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime86.jsxs)(Container, { flex: "row", children: [(0, import_jsx_runtime86.jsx)(Container, { flex: "column", expand: true, children: (0, import_jsx_runtime86.jsx)(Text, { size: "xs", color: "secondaryText", children: "Network" }) }), (0, import_jsx_runtime86.jsx)(Container, { expand: true, children: (0, import_jsx_runtime86.jsxs)(Container, { flex: "row", gap: "xs", center: "y", style: { justifyContent: "right" }, children: [(0, import_jsx_runtime86.jsx)(ChainIcon, { chainIconUrl: (_f = chainData.icon) == null ? void 0 : _f.url, size: "xs", client: props.client }), (0, import_jsx_runtime86.jsx)(Text, { size: "xs", color: "secondaryText", style: { textAlign: "right" }, children: chainData.name })] }) })] }), (0, import_jsx_runtime86.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime86.jsxs)(Container, { flex: "row", children: [(0, import_jsx_runtime86.jsx)(Container, { flex: "column", expand: true, children: (0, import_jsx_runtime86.jsx)(Text, { size: "xs", color: "secondaryText", children: "Seller" }) }), (0, import_jsx_runtime86.jsx)(Container, { expand: true, children: (0, import_jsx_runtime86.jsx)(Container, { flex: "row", gap: "xs", center: "y", style: { justifyContent: "right" }, children: (0, import_jsx_runtime86.jsx)(Text, { size: "xs", color: "secondaryText", style: { textAlign: "right" }, children: sellerEns || shortenAddress(paymentInfo.sellerAddress) }) }) })] })] }), (0, import_jsx_runtime86.jsx)(Spacer, { y: "xl" }), payerAccount ? (0, import_jsx_runtime86.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    trackPayEvent({
  ...
  }, children: "Choose Payment Method" }) : (0, import_jsx_runtime86.jsx)("div", { children: (0, import_jsx_runtime86.jsx)(ConnectButton, { ...props.connectOptions, client, theme, connectButton: {
    style: {
      width: "100%"
    }
  } }) })] });
...
function EstimatedTimeAndFees(props) {
  ...
  return (0, import_jsx_runtime87.jsxs)(Container, { bg: "tertiaryBg", flex: "row", borderColor: "borderColor", style: {
    borderRadius: radius.md,
    ...
    borderWidth: "1px",
    borderStyle: "solid"
  }, children: [(0, import_jsx_runtime87.jsxs)(Container, { flex: "row", center: "y", gap: "xxs", color: "accentText", p: "sm", children: [(0, import_jsx_runtime87.jsx)(ClockIcon, { width: iconSize.sm, height: iconSize.sm }), quoteIsLoading ? (0, import_jsx_runtime87.jsx)(Skeleton, { height: fontSize.xs, width: "50px", color: "borderColor" }) : (0, import_jsx_runtime87.jsx)(Text, { size: "xs", color: "secondaryText", children: estimatedSeconds !== void 0 ? `~${formatSeconds(estimatedSeconds)}` : "--" })] }), (0, import_jsx_runtime87.jsxs)(Button, { variant: "ghost", onClick: props.onViewFees, gap: "xs", children: [(0, import_jsx_runtime87.jsx)(Container, { color: "accentText", flex: "row", center: "both", children: (0, import_jsx_runtime87.jsx)(ViewFeeIcon, { size: iconSize.sm }) }), (0, import_jsx_runtime87.jsx)(Text, { size: "xs", color: "secondaryText", children: "View Fees" })] })] });
}
var ViewFeeIcon = (props) => {
  return (0, import_jsx_runtime87.jsxs)("svg", { width: props.size, height: props.size, viewBox: "0 0 12 12", fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true", children: [(0, import_jsx_runtime87.jsx)("path", { d: "M9.5 1.5H2.5C1.94772 1.5 1.5 1.94772 1.5 2.5V9.5C1.5 10.0523 1.94772 10.5 2.5 10.5H9.5C10.0523 10.5 10.5 10.0523 10.5 9.5V2.5C10.5 1.94772 10.0523 1.5 9.5 1.5Z", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime87.jsx)("path", { d: "M4.5 7.5L7.5 4.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" })] });
};
...
function PayWithCreditCard(props) {
  return (0, import_jsx_runtime88.jsxs)(Container, { bg: "tertiaryBg", borderColor: "borderColor", flex: "row", style: {
    borderRadius: radius.md,
    borderBottomRightRadius: 0,
    borderBottomLeftRadius: 0,
    borderWidth: "1px",
    ...
    justifyContent: "space-between",
    alignItems: "center"
  }, children: [(0, import_jsx_runtime88.jsxs)(CurrencyButton, { variant: "ghost", onClick: props.onSelectCurrency, style: {
    minHeight: "64px",
    justifyContent: "flex-start",
    minWidth: "50%"
  }, gap: "sm", children: [(0, import_jsx_runtime88.jsx)(props.currency.icon, { size: iconSize.md }), (0, import_jsx_runtime88.jsxs)(Container, { flex: "row", center: "y", gap: "xxs", color: "secondaryText", children: [(0, import_jsx_runtime88.jsx)(Text, { color: "primaryText", children: props.currency.shorthand }), (0, import_jsx_runtime88.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm })] })] }), (0, import_jsx_runtime88.jsx)("div", { style: {
    flexGrow: 1,
    flexShrink: 1,
    display: "flex",
    flexDirection: "column",
  ...
  }, children: props.isLoading ? (0, import_jsx_runtime88.jsx)(Skeleton, { width: "100px", height: fontSize.lg }) : (0, import_jsx_runtime88.jsx)(Text, { size: "lg", color: props.value ? "primaryText" : "secondaryText", children: props.value ? `${formatNumber(Number(props.value), 6)}` : "--" }) })] });
}
...
function useTransactionCostAndData(args) {
  ...
  const [txQueryKey, setTxQueryKey] = (0, import_react52.useState)();
...
function WalletSelectorButton(props) {
  const theme = useCustomTheme();
  return (0, import_jsx_runtime90.jsx)(Container, { bg: "tertiaryBg", style: {
    borderRadius: radius.lg,
    border: `1px solid ${theme.colors.borderColor}`,
    ...props.containerStyle
  }, children: (0, import_jsx_runtime90.jsxs)(Button, { fullWidth: true, disabled: props.disabled, onClick: props.onClick, variant: "ghost", style: {
    justifyContent: "space-between",
    padding: spacing.sm,
    backgroundColor: theme.colors.tertiaryBg
  }, gap: "sm", children: [(0, import_jsx_runtime90.jsx)(WalletRow, { client: props.client, address: props.address }), !props.disableChevron && (0, import_jsx_runtime90.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    color: theme.colors.secondaryText
  } }), props.checked && (0, import_jsx_runtime90.jsx)(CheckIcon, { width: iconSize.md, height: iconSize.md })] }) });
}
function WalletRow(props) {
  const { client, address } = props;
  const connectedWallets = useConnectedWallets();
  const wallet = connectedWallets.find((x) => {
    var _a;
    return ((_a = x.getAccount()) == null ? void 0 : _a.address) === props.address;
  });
  const walletId = props.walletId || (wallet == null ? void 0 : wallet.id);
  ...
  return (0, import_jsx_runtime90.jsxs)(Container, { flex: "row", center: "y", gap: "sm", color: "secondaryText", children: [ensAvatarQuery.data ? (0, import_jsx_runtime90.jsx)(Img, { src: ensAvatarQuery.data, width: iconSize.md, height: iconSize.md, style: {
    borderRadius: radius.sm
  }, client: props.client }) : walletId ? (0, import_jsx_runtime90.jsx)(WalletImage, { id: walletId, size: iconSize.md, client: props.client }) : null, (0, import_jsx_runtime90.jsx)(Text, { size: "sm", color: "primaryText", children: addressOrENS || shortenAddress(props.address) })] });
}
...
function CurrencySelection(props) {
  return (0, import_jsx_runtime91.jsxs)(Container, { children: [(0, import_jsx_runtime91.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime91.jsx)(ModalHeader, { title: "Pay with", onBack: props.onBack }) }), (0, import_jsx_runtime91.jsx)(Line, {}), (0, import_jsx_runtime91.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime91.jsx)(Container, { flex: "column", gap: "xs", px: "lg", children: currencies.map((c) => {
    return (0, import_jsx_runtime91.jsxs)(SelectCurrencyButton, { fullWidth: true, variant: "secondary", onClick: () => props.onSelect(c), gap: "sm", children: [(0, import_jsx_runtime91.jsx)(c.icon, { size: iconSize.lg }), (0, import_jsx_runtime91.jsxs)(Container, { flex: "column", gap: "xxs", children: [(0, import_jsx_runtime91.jsx)(Text, { color: "primaryText", children: c.shorthand }), (0, import_jsx_runtime91.jsx)(Text, { size: "sm", children: c.name })] })] }, c.shorthand);
  }) }), (0, import_jsx_runtime91.jsx)(Spacer, { y: "lg" })] });
}
...
function OnrampStatusScreen(props) {
  ...
  const purchaseCbCalled = (0, import_react53.useRef)(false);
  ...
  const invalidatedBalance = (0, import_react53.useRef)(false);
  (0, import_react53.useEffect)(() => {
    var _a2;
  ...
  return (0, import_jsx_runtime92.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime92.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), props.hasTwoSteps && (0, import_jsx_runtime92.jsxs)(import_jsx_runtime92.Fragment, { children: [(0, import_jsx_runtime92.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime92.jsx)(StepBar, { steps: 2, currentStep: 1 }), (0, import_jsx_runtime92.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime92.jsxs)(Text, { size: "xs", children: ["Step 1 of 2 - Buying ", props.quote.onRampToken.token.symbol, " with", " ", props.quote.fromCurrencyWithFees.currencySymbol] })] }), (0, import_jsx_runtime92.jsx)(OnrampStatusScreenUI, { uiStatus, onDone: props.onDone, fiatStatus: statusQuery.data, client: props.client, transactionMode: props.transactionMode, quote: props.quote, isEmbed: props.isEmbed })] });
}
function OnrampStatusScreenUI(props) {
  ...
  const txDetails = (0, import_jsx_runtime92.jsx)(OnRampTxDetailsTable, { client: props.client, token: (fiatStatus == null ? void 0 : fiatStatus.source) ? {
  ...
  return (0, import_jsx_runtime92.jsxs)(Container, { children: [(0, import_jsx_runtime92.jsx)(Spacer, { y: "xl" }), uiStatus === "loading" && (0, import_jsx_runtime92.jsxs)(import_jsx_runtime92.Fragment, { children: [(0, import_jsx_runtime92.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime92.jsx)(Container, { flex: "row", center: "x", children: (0, import_jsx_runtime92.jsx)(Spinner, { size: "xxl", color: "accentText" }) }), (0, import_jsx_runtime92.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime92.jsx)(Text, { color: "primaryText", size: "lg", center: true, children: "Buy Pending" }), (0, import_jsx_runtime92.jsx)(Spacer, { y: "sm" }), !isMobile() && (0, import_jsx_runtime92.jsx)(Text, { center: true, children: "Complete the purchase in popup" }), (0, import_jsx_runtime92.jsx)(Spacer, { y: "xxl" }), txDetails] }), uiStatus === "failed" && (0, import_jsx_runtime92.jsxs)(import_jsx_runtime92.Fragment, { children: [(0, import_jsx_runtime92.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime92.jsx)(Container, { flex: "row", center: "x", children: (0, import_jsx_runtime92.jsx)(AccentFailIcon, { size: iconSize["3xl"] }) }), (0, import_jsx_runtime92.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime92.jsx)(Text, { color: "primaryText", size: "lg", center: true, children: "Transaction Failed" }), (0, import_jsx_runtime92.jsx)(Spacer, { y: "xxl" }), txDetails] }), uiStatus === "completed" && (0, import_jsx_runtime92.jsxs)(import_jsx_runtime92.Fragment, { children: [(0, import_jsx_runtime92.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime92.jsx)(Container, { flex: "row", center: "x", color: "success", children: (0, import_jsx_runtime92.jsx)(CheckCircledIcon, { width: iconSize["3xl"], height: iconSize["3xl"] }) }), (0, import_jsx_runtime92.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime92.jsx)(Text, { color: "primaryText", size: "lg", center: true, children: "Buy Complete" }), props.fiatStatus && props.fiatStatus.status !== "NOT_FOUND" && (0, import_jsx_runtime92.jsxs)(import_jsx_runtime92.Fragment, { children: [(0, import_jsx_runtime92.jsx)(Spacer, { y: "xxl" }), txDetails, (0, import_jsx_runtime92.jsx)(Spacer, { y: "sm" })] }), !props.isEmbed && (0, import_jsx_runtime92.jsx)(Button, { variant: "accent", fullWidth: true, onClick: props.onDone, children: props.transactionMode ? "Continue Transaction" : "Done" })] })] });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/fiat/FiatFlow.js
function FiatFlow(props) {
  const hasTwoSteps = isSwapRequiredPostOnramp(props.quote);
  const [screen, setScreen] = (0, import_react54.useState)(hasTwoSteps ? {
    id: "step-1"
  } : {
    id: "onramp-status"
  });
  const [popupWindow, setPopupWindow] = (0, import_react54.useState)(props.openedWindow);
  const onPostOnrampSuccess = (0, import_react54.useCallback)(() => {
  ...
  if (screen.id === "step-1") {
    return (0, import_jsx_runtime93.jsx)(FiatSteps, { title: props.title, client: props.client, onBack: props.onBack, partialQuote: fiatQuoteToPartialQuote(props.quote), step: 1, onContinue: () => {
  ...
  if (screen.id === "onramp-status") {
    return (0, import_jsx_runtime93.jsx)(OnrampStatusScreen, { title: props.title, client: props.client, intentId: props.quote.intentId, onBack: props.onBack, hasTwoSteps, openedWindow: popupWindow, quote: props.quote, onDone: props.onDone, onShowSwapFlow: (_status) => {
      setScreen({ id: "postonramp-swap", data: _status });
    }, transactionMode: props.transactionMode, isEmbed: props.isEmbed, onSuccess: props.onSuccess });
  }
  if (screen.id === "postonramp-swap") {
    return (0, import_jsx_runtime93.jsx)(PostOnRampSwapFlow, { title: props.title, status: screen.data, quote: fiatQuoteToPartialQuote(props.quote), client: props.client, onBack: props.onBack, onDone: props.onDone, onSwapFlowStarted: () => {
...
function useToTokenSelectionStates(options) {
  ...
  const [tokenAmount, setTokenAmount] = (0, import_react55.useState)(initialTokenAmount);
  const deferredTokenAmount = useDebouncedValue(tokenAmount, 300);
  const [toChain, setToChain] = (0, import_react55.useState)(
  ...
  const [toToken, setToToken] = (0, import_react55.useState)((prefillBuy == null ? void 0 : prefillBuy.token) || payOptions.mode === "direct_payment" && payOptions.paymentInfo.token || NATIVE_TOKEN);
  return {
    toChain,
    setToChain,
    toToken,
...
function useFromTokenSelectionStates(options) {
  ...
  const [fromChain_, setFromChain] = (0, import_react55.useState)();
  ...
  const [fromToken_, setFromToken] = (0, import_react55.useState)();
...
function useFiatCurrencySelectionStates(options) {
  ...
  const [selectedCurrency, setSelectedCurrency] = (0, import_react55.useState)(currencies.find((x) => x.shorthand === defaultSelectedCurrencyShorthand) || usdCurrency);
  return {
    selectedCurrency,
    setSelectedCurrency
  };
...
function BuyTokenInput(props) {
  ...
  return (0, import_jsx_runtime94.jsxs)(Container, { children: [(0, import_jsx_runtime94.jsx)("div", { onClick: (e) => {
    var _a;
    (_a = e.currentTarget.querySelector("input")) == null ? void 0 : _a.focus();
  }, children: (0, import_jsx_runtime94.jsxs)(Container, { flex: "row", center: "both", gap: "xs", style: {
    flexWrap: "nowrap"
  }, children: [(0, import_jsx_runtime94.jsx)(Input, { variant: "outline", pattern: "^[0-9]*[.,]?[0-9]*$", inputMode: "decimal", tabIndex: -1, placeholder: "0", type: "text", "data-placeholder": props.value === "", value: props.value || "0", disabled: props.freezeAmount, onClick: (e) => {
    if (props.value === "") {
  ...
  } }), (0, import_jsx_runtime94.jsx)(TokenSymbol, { token: props.token, chain: props.chain, size: "lg", color: "secondaryText" })] }) }), !props.hideTokenSelector && (0, import_jsx_runtime94.jsxs)(import_jsx_runtime94.Fragment, { children: [(0, import_jsx_runtime94.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime94.jsx)(Container, { flex: "row", center: "x", children: (0, import_jsx_runtime94.jsxs)(TokenButton, { variant: "secondary", fullWidth: true, style: {
    fontSize: fontSize.sm
  }, gap: "xxs", onClick: props.onSelectToken, disabled: props.freezeChainAndToken, children: [(0, import_jsx_runtime94.jsxs)(Container, { flex: "row", center: "y", gap: "sm", children: [(0, import_jsx_runtime94.jsx)(TokenIcon, { token: props.token, chain: props.chain, size: "md", client: props.client }), (0, import_jsx_runtime94.jsxs)(Container, { flex: "column", style: {
    gap: "4px"
  }, children: [(0, import_jsx_runtime94.jsx)(TokenSymbol, { token: props.token, chain: props.chain, size: "sm" }), name ? (0, import_jsx_runtime94.jsx)(Text, { size: "xs", color: "secondaryText", children: name }) : (0, import_jsx_runtime94.jsx)(Skeleton, { width: "90px", height: fontSize.xs })] })] }), (0, import_jsx_runtime94.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    marginLeft: "auto"
  } })] }) })] })] });
}
...
function SwapFees(props) {
  return (0, import_jsx_runtime95.jsx)(Container, { flex: "column", gap: "xs", style: {
    alignItems: "flex-start"
  }, children: props.quote.processingFees.map((fee) => {
    const feeAmount = formatNumber(Number(fee.amount), 6);
    return (0, import_jsx_runtime95.jsxs)(Container, { flex: "row", gap: "xxs", children: [(0, import_jsx_runtime95.jsxs)(Text, { color: "primaryText", size: "sm", children: [feeAmount === 0 ? "~" : "", feeAmount, " ", fee.token.symbol] }), (0, import_jsx_runtime95.jsxs)(Text, { color: "secondaryText", size: "sm", children: ["($", (fee.amountUSDCents / 100).toFixed(2), ")"] })] }, `${fee.token.chainId}_${fee.token.tokenAddress}_${feeAmount}`);
  }) });
}
function FiatFees(props) {
  return (0, import_jsx_runtime95.jsxs)(Container, { flex: "column", gap: "xs", children: [(0, import_jsx_runtime95.jsxs)("div", { style: {
    display: "flex",
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime95.jsx)(Text, { inline: true, color: "secondaryText", children: "Amount" }), (0, import_jsx_runtime95.jsxs)(Text, { color: "primaryText", inline: true, children: [formatNumber(Number(props.quote.fromCurrency.amount), 2), " ", props.quote.fromCurrency.currencySymbol] })] }), props.quote.processingFees.map((fee, i) => {
    const feeAmount = formatNumber(Number(fee.amount), 6);
    return (0, import_jsx_runtime95.jsxs)("div", { style: {
      display: "flex",
      justifyContent: "space-between"
    }, children: [(0, import_jsx_runtime95.jsx)(Text, { inline: true, color: "secondaryText", children: fee.feeType === "NETWORK" ? "Network Fee" : "Processing Fee" }), (0, import_jsx_runtime95.jsxs)(Text, { color: "primaryText", inline: true, children: [feeAmount === 0 ? "~" : "", " ", feeAmount, " ", fee.currencySymbol] })] }, i);
  }), (0, import_jsx_runtime95.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime95.jsx)(Line, {}), (0, import_jsx_runtime95.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime95.jsxs)("div", { style: {
    display: "flex",
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime95.jsx)(Text, { inline: true, color: "secondaryText", children: "Total" }), (0, import_jsx_runtime95.jsxs)(Text, { color: "primaryText", inline: true, children: [formatNumber(Number(props.quote.fromCurrencyWithFees.amount), 6), " ", props.quote.fromCurrencyWithFees.currencySymbol] })] })] });
}
...
var GenericWalletIcon = (props) => {
  return (0, import_jsx_runtime96.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 18 18", width: props.size, height: props.size, role: "presentation", children: (0, import_jsx_runtime96.jsx)("path", { fill: "currentColor", d: "M15.6 4.6H1.85v-.55l12.1-.968v.968h1.65V2.4c0-1.21-.98-2.059-2.177-1.888L2.378 2.089C1.18 2.26.2 3.39.2 4.6v11a2.2 2.2 0 002.2 2.2h13.2a2.2 2.2 0 002.2-2.2V6.8a2.2 2.2 0 00-2.2-2.2zm-1.65 7.707a1.65 1.65 0 01-.63-3.176 1.65 1.65 0 11.63 3.176z" }) });
};
...
function PayWithCrypto(props) {
  ...
  return (0, import_jsx_runtime97.jsxs)(Container, { bg: "tertiaryBg", borderColor: "borderColor", flex: "row", style: {
    borderWidth: "1px",
    borderTopWidth: 0,
    borderStyle: "solid",
    flexWrap: "nowrap",
    ...
    minHeight: "64px",
    alignItems: "center",
    ...props.swapRequired ? { borderBottom: "none" } : {
      borderBottomLeftRadius: radius.md,
      borderBottomRightRadius: radius.md
    }
  }, children: [(0, import_jsx_runtime97.jsxs)(Button, { variant: "ghost", onClick: props.onSelectToken, gap: "sm", style: {
    paddingInline: spacing.sm,
    paddingBlock: spacing.sm,
    minWidth: "50%",
    justifyContent: "flex-start"
  }, disabled: props.freezeChainAndTokenSelection, children: [(0, import_jsx_runtime97.jsx)(PayTokenIcon, { token: props.token, chain: props.chain, size: "md", client: props.client }), (0, import_jsx_runtime97.jsxs)(Container, { flex: "column", gap: "3xs", children: [(0, import_jsx_runtime97.jsxs)(Container, { flex: "row", gap: "xs", center: "y", color: "primaryText", children: [(0, import_jsx_runtime97.jsx)(TokenSymbol, { token: props.token, chain: props.chain, size: "sm" }), (0, import_jsx_runtime97.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm })] }), name ? (0, import_jsx_runtime97.jsx)(Text, { size: "xs", children: name }) : (0, import_jsx_runtime97.jsx)(Skeleton, { width: "90px", height: fontSize.xs })] })] }), (0, import_jsx_runtime97.jsxs)("div", { style: {
    flexGrow: 1,
    flexShrink: 1,
    display: "flex",
    flexDirection: "column",
    ...
    justifyContent: "center",
    paddingRight: spacing.sm
  }, children: [props.isLoading ? (0, import_jsx_runtime97.jsx)(Skeleton, { width: "120px", height: fontSize.md, color: "borderColor" }) : (0, import_jsx_runtime97.jsx)(Text, { size: "md", color: props.value ? "primaryText" : "secondaryText", style: {}, children: formatNumber(Number(props.value), 6) || "" }), (0, import_jsx_runtime97.jsxs)(Container, { flex: "row", gap: "xxs", center: "y", color: "secondaryText", children: [(0, import_jsx_runtime97.jsx)(GenericWalletIcon, { size: fontSize.xs }), balanceQuery.data ? (0, import_jsx_runtime97.jsx)(Text, { size: "xs", color: "secondaryText", weight: 500, children: formatTokenBalance(balanceQuery.data, false) }) : (0, import_jsx_runtime97.jsx)(Skeleton, { width: "70px", height: fontSize.xs })] })] })] });
}
...
function TransferConfirmationScreen(props) {
  ...
  const [step, setStep] = (0, import_react56.useState)("transfer");
  const [status, setStatus] = (0, import_react56.useState)({ id: "idle" });
  const { symbol } = useChainSymbol(chain);
  return (0, import_jsx_runtime98.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime98.jsx)(ModalHeader, { title, onBack }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "xl" }), transactionMode && (0, import_jsx_runtime98.jsxs)(import_jsx_runtime98.Fragment, { children: [(0, import_jsx_runtime98.jsx)(StepBar, { steps: 2, currentStep: step === "transfer" ? 1 : 2 }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime98.jsx)(Text, { size: "sm", children: step === "transfer" ? "Step 1 of 2 - Transfer funds" : "Step 2 of 2 - Finalize transaction" }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "xl" })] }), (0, import_jsx_runtime98.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime98.jsx)(Text, { size: "sm", children: "From" }), (0, import_jsx_runtime98.jsx)(WalletRow, { address: payer.account.address, client })] }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime98.jsx)(Line, {}), (0, import_jsx_runtime98.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime98.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime98.jsx)(Text, { size: "sm", children: "To" }), (0, import_jsx_runtime98.jsx)(WalletRow, { address: receiverAddress, client })] }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime98.jsx)(Line, {}), (0, import_jsx_runtime98.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime98.jsx)(TokenInfoRow, { chainId: chain.id, client, label: "Amount", tokenAmount, tokenSymbol: isNativeToken(token) ? symbol || "" : token.symbol, tokenAddress: isNativeToken(token) ? NATIVE_TOKEN_ADDRESS : token.address }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "lg" }), transactionMode && (0, import_jsx_runtime98.jsxs)(import_jsx_runtime98.Fragment, { children: [(0, import_jsx_runtime98.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime98.jsxs)(Container, { gap: "sm", flex: "row", style: {
    justifyContent: "space-between"
  }, center: "y", color: "accentText", children: [(0, import_jsx_runtime98.jsx)(Step, { isDone: step === "execute", isActive: step === "transfer", label: step === "transfer" ? "Transfer" : "Done" }), (0, import_jsx_runtime98.jsx)(ConnectorLine, {}), (0, import_jsx_runtime98.jsx)(Step, { isDone: false, label: "Finalize", isActive: step === "execute" })] }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "lg" })] }), status.id === "error" && (0, import_jsx_runtime98.jsxs)(import_jsx_runtime98.Fragment, { children: [(0, import_jsx_runtime98.jsx)(Container, { flex: "row", gap: "xs", center: "both", color: "danger", children: (0, import_jsx_runtime98.jsx)(Text, { color: "danger", size: "sm", style: { textAlign: "center" }, children: step === "transfer" ? `${status.error || "Failed to Transfer"}` : "Failed to Execute" }) }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "md" })] }), !transactionMode && step === "execute" && status.id === "done" && (0, import_jsx_runtime98.jsxs)(import_jsx_runtime98.Fragment, { children: [(0, import_jsx_runtime98.jsxs)(Container, { flex: "row", gap: "xs", center: "both", color: "success", children: [(0, import_jsx_runtime98.jsx)(CheckCircledIcon, { width: iconSize.sm, height: iconSize.sm }), (0, import_jsx_runtime98.jsx)(Text, { color: "success", size: "sm", children: "Payment completed" })] }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "md" })] }), payer.chain.id !== chain.id ? (0, import_jsx_runtime98.jsx)(SwitchNetworkButton, { fullWidth: true, variant: "accent", switchChain: async () => {
    await props.payer.wallet.switchChain(chain);
  } }) : (0, import_jsx_runtime98.jsxs)(Button, { variant: "accent", fullWidth: true, disabled: status.id === "pending", onClick: async () => {
    var _a;
    if (step === "execute") {
      onDone();
      return;
  ...
  }, gap: "xs", children: [step === "execute" && (status.id === "done" ? "Done" : "Continue"), step === "transfer" && (status.id === "pending" ? "Confirming" : "Confirm"), step === "approve" && (status.id === "pending" ? "Approving" : "Approve"), status.id === "pending" && (0, import_jsx_runtime98.jsx)(Spinner, { size: "sm", color: "accentButtonText" })] })] });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/swap/TransferFlow.js
function TransferFlow(props) {
  const [transferTxHash, setTransferTxHash] = (0, import_react57.useState)();
  if (transferTxHash) {
    return (0, import_jsx_runtime99.jsx)(SwapStatusScreen, { title: props.title, onBack: props.onBack, onTryAgain: props.onTryAgain, swapTxHash: transferTxHash, client: props.client, onDone: props.onDone, transactionMode: false, isEmbed: props.isEmbed, quote: void 0, onSuccess: props.onSuccess });
  }
  return (0, import_jsx_runtime99.jsx)(TransferConfirmationScreen, { ...props, setTransactionHash: setTransferTxHash });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/swap/WalletSwitcherDrawerContent.js
...
function WalletSwitcherDrawerContent(props) {
  ...
  const connectedWallets = useConnectedWallets();
  const hideConnectButton = !props.showAllWallets && ((_a = props.wallets) == null ? void 0 : _a.every((w) => connectedWallets.includes(w)));
  return (0, import_jsx_runtime100.jsxs)(Container, { children: [(0, import_jsx_runtime100.jsxs)(Container, { flex: "column", gap: "xs", children: [connectedWallets.filter((w) => {
    var _a2;
    return !((_a2 = props.hiddenWallets) == null ? void 0 : _a2.includes(w.id));
  }).map((w) => {
    var _a2;
    const address = (_a2 = w.getAccount()) == null ? void 0 : _a2.address;
    return (0, import_jsx_runtime100.jsx)(WalletSelectorButton, { walletId: w.id, client: props.client, address: address || "", onClick: () => {
      props.onSelect(w);
      props.onBack();
    }, disableChevron: true, checked: false }, w.id);
  }), !hideConnectButton && (0, import_jsx_runtime100.jsx)(Button, { variant: "secondary", fullWidth: true, onClick: props.onConnect, gap: "xs", bg: "tertiaryBg", style: {
    borderRadius: radius.lg,
    border: `1px solid ${theme.colors.borderColor}`,
    padding: spacing.sm
  }, children: (0, import_jsx_runtime100.jsxs)(Container, { flex: "row", gap: "sm", center: "y", expand: true, children: [(0, import_jsx_runtime100.jsx)(PlusIcon, { width: iconSize.md, height: iconSize.md }), (0, import_jsx_runtime100.jsx)(Text, { size: "sm", color: "primaryText", children: "Add Another Wallet" })] }) })] }), (0, import_jsx_runtime100.jsx)(Spacer, { y: "sm" })] });
}
...
function usePayerSetup() {
  ...
  const account = useActiveAccount();
  const activeChain = useActiveWalletChain();
  const [_payer, setPayer] = (0, import_react58.useState)();
...
function BuyScreen2(props) {
  ...
  if (!supportedDestinationsQuery.data) {
    return (0, import_jsx_runtime101.jsx)(LoadingScreen, {});
  }
  return (0, import_jsx_runtime101.jsx)(BuyScreenContent, { ...props, supportedDestinations: supportedDestinationsQuery.data });
}
function BuyScreenContent(props) {
  ...
  const [screen, setScreen] = (0, import_react59.useState)({
    id: "main"
  });
  ...
  const [hasEditedAmount, setHasEditedAmount] = (0, import_react59.useState)(false);
  const onDone = (0, import_react59.useCallback)(() => {
    setScreen({ id: "main" });
    props.onDone();
  }, [props.onDone]);
  ...
  const destinationSupportedTokens = (0, import_react59.useMemo)(() => {
  ...
  const sourceSupportedTokens = (0, import_react59.useMemo)(() => {
  ...
  const payDisabled = enabledPaymentMethods.showPaymentSelection === false && enabledPaymentMethods.buyWithCryptoEnabled === false && enabledPaymentMethods.buyWithFiatEnabled === false;
  const queryClient = useQueryClient();
  const onSwapSuccess = (0, import_react59.useCallback)((_status) => {
    var _a2, _b2;
  ...
  const onFiatSuccess = (0, import_react59.useCallback)((_status) => {
    var _a2, _b2;
    (_b2 = (_a2 = props.payOptions).onPurchaseSuccess) == null ? void 0 : _b2.call(_a2, {
      type: "fiat",
      status: _status
  ...
  if (screen.id === "swap-flow" && payer) {
    return (0, import_jsx_runtime101.jsx)(SwapFlow, { title: props.title, transactionMode: payOptions.mode === "transaction", isEmbed: props.isEmbed, client, onBack: () => {
      setScreen({
        id: "buy-with-crypto"
      });
  ...
  if (screen.id === "fiat-flow" && payer) {
    return (0, import_jsx_runtime101.jsx)(FiatFlow, { title: props.title, transactionMode: payOptions.mode === "transaction", quote: screen.quote, onBack: () => {
      setScreen({
        id: "buy-with-fiat"
      });
  ...
  if (screen.id === "transfer-flow" && payer && activeAccount) {
    ...
    return (0, import_jsx_runtime101.jsx)(TransferFlow, { title: props.title, onBack: goBack, payer, client: props.client, chain: toChain, token: toToken, tokenAmount, receiverAddress, transactionMode: props.payOptions.mode === "transaction", payOptions, isEmbed: props.isEmbed, onDone, onTryAgain: () => {
      setScreen({
        id: "buy-with-crypto"
      });
    }, onSuccess: onSwapSuccess });
  ...
  if (screen.id === "select-currency") {
    ...
    return (0, import_jsx_runtime101.jsx)(CurrencySelection, { onSelect: (currency) => {
      goBack();
  ...
  if (screen.id === "select-to-token") {
    ...
    if ((allowEdits == null ? void 0 : allowEdits.token) === false) {
      return (0, import_jsx_runtime101.jsx)(ChainSelectionScreen, { chains, client: props.client, connectLocale: props.connectLocale, setChain: setToChain, goBack });
    }
    return (0, import_jsx_runtime101.jsx)(TokenSelector, { onBack: goBack, tokenList: (((toChain == null ? void 0 : toChain.id) ? destinationSupportedTokens[toChain.id] : void 0) || []).filter((x) => x.address !== NATIVE_TOKEN_ADDRESS), onTokenSelect: (tokenInfo) => {
  ...
  if (screen.id === "select-from-token" && supportedSourcesQuery.data && sourceSupportedTokens) {
    ...
    if (payOptions.buyWithCrypto !== false && ((_q = (_p = (_o = payOptions.buyWithCrypto) == null ? void 0 : _o.prefillSource) == null ? void 0 : _p.allowEdits) == null ? void 0 : _q.token) === false) {
      return (0, import_jsx_runtime101.jsx)(ChainSelectionScreen, { chains, client: props.client, connectLocale: props.connectLocale, setChain: setFromChain, goBack });
    }
    return (0, import_jsx_runtime101.jsx)(TokenSelector, { onBack: goBack, tokenList: (((fromChain == null ? void 0 : fromChain.id) ? sourceSupportedTokens[fromChain.id] : void 0) || []).filter((x) => x.address !== NATIVE_TOKEN_ADDRESS), onTokenSelect: (tokenInfo) => {
  ...
  }, children: [screen.id === "select-payment-method" && (0, import_jsx_runtime101.jsx)(PaymentMethodSelection, { mode: payOptions.mode, client, walletAddress: payer.account.address, walletType: payer.wallet.id, setScreen: (id) => setScreen({ id }) }), screen.id === "select-wallet" && (0, import_jsx_runtime101.jsx)(WalletSwitcherDrawerContent, { client, hiddenWallets: props.hiddenWallets, onSelect: (w) => {
    const chain = w.getChain();
    const account = w.getAccount();
    if (chain && account) {
      setPayer({
  ...
  }, selectedAddress: payer.account.address }), screen.id === "buy-with-crypto" && activeAccount && (0, import_jsx_runtime101.jsx)(SwapScreenContent, {
    setScreen,
  ...
  }), screen.id === "buy-with-fiat" && (0, import_jsx_runtime101.jsx)(FiatScreenContent, { setScreen, tokenAmount: deferredTokenAmount, toChain, toToken, selectedCurrency, client, isEmbed: props.isEmbed, onDone, payOptions, theme: props.theme, showCurrencySelector: () => {
    setScreen({
      id: "select-currency",
      backScreen: screen
    });
...
function SelectedTokenInfo(props) {
  return (0, import_jsx_runtime101.jsx)("div", { children: (0, import_jsx_runtime101.jsxs)(Container, { flex: "row", gap: "sm", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime101.jsxs)(Container, { flex: "row", gap: "xs", center: "y", children: [(0, import_jsx_runtime101.jsx)(Text, { color: "primaryText", "data-testid": "tokenAmount", size: "xl", children: formatNumber(Number(props.tokenAmount), 6) }), (0, import_jsx_runtime101.jsxs)(Container, { flex: "row", gap: "xxs", center: "y", children: [(0, import_jsx_runtime101.jsx)(TokenSymbol, { token: props.selectedToken, chain: props.selectedChain, size: "md", color: "secondaryText" }), (0, import_jsx_runtime101.jsx)(PayTokenIcon, { chain: props.selectedChain, client: props.client, size: "sm", token: props.selectedToken })] })] }), (0, import_jsx_runtime101.jsx)(ChainName, { chain: props.selectedChain, client: props.client, size: "sm", short: true })] }) });
}
function MainScreen(props) {
  ...
  switch (payOptions.mode) {
    case "transaction": {
      return (0, import_jsx_runtime101.jsx)(TransactionModeScreen, { supportedDestinations, payUiOptions: payOptions, payerAccount, connectOptions: props.connectOptions, client, onContinue: (tokenAmount2, toChain2, toToken2) => {
    ...
    case "direct_payment": {
      return (0, import_jsx_runtime101.jsx)(DirectPaymentModeScreen, { client, payUiOptions: payOptions, payerAccount, connectOptions: props.connectOptions, supportedDestinations, onContinue: (tokenAmount2, toChain2, toToken2) => {
        setTokenAmount(tokenAmount2);
        setToChain(toChain2);
        setFromChain(toChain2);
        setFromToken(toToken2);
    ...
    default: {
      return (0, import_jsx_runtime101.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime101.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), (0, import_jsx_runtime101.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime101.jsx)(BuyTokenInput, { value: tokenAmount, onChange: async (value) => {
        props.setHasEditedAmount(true);
        setTokenAmount(value);
      }, freezeAmount: ((_b = (_a = payOptions.prefillBuy) == null ? void 0 : _a.allowEdits) == null ? void 0 : _b.amount) === false, freezeChainAndToken: ((_d = (_c = payOptions.prefillBuy) == null ? void 0 : _c.allowEdits) == null ? void 0 : _d.chain) === false && ((_f = (_e = payOptions.prefillBuy) == null ? void 0 : _e.allowEdits) == null ? void 0 : _f.token) === false, token: toToken, chain: toChain, onSelectToken: props.onSelectBuyToken, client: props.client }), (0, import_jsx_runtime101.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime101.jsx)(Container, { flex: "column", gap: "sm", children: !payerAccount ? (0, import_jsx_runtime101.jsx)("div", { children: (0, import_jsx_runtime101.jsx)(ConnectButton, { ...props.connectOptions, client: props.client, theme: props.theme, connectButton: {
        style: {
          width: "100%"
        }
      } }) }) : (0, import_jsx_runtime101.jsx)(Button, { variant: "accent", fullWidth: true, disabled: disableContinue, "data-disabled": disableContinue, onClick: () => {
        if (showPaymentSelection) {
          props.setScreen({ id: "select-payment-method" });
        } else if (buyWithCryptoEnabled) {
          props.setScreen({ id: "buy-with-crypto" });
...
function TokenSelectedLayout(props) {
  return (0, import_jsx_runtime101.jsxs)(Container, { children: [(0, import_jsx_runtime101.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime101.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }) }), (0, import_jsx_runtime101.jsxs)(Container, { px: "lg", style: {
    paddingBottom: spacing.lg
  }, children: [(0, import_jsx_runtime101.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime101.jsx)(SelectedTokenInfo, { selectedToken: props.selectedToken, selectedChain: props.selectedChain, tokenAmount: props.tokenAmount, client: props.client }), (0, import_jsx_runtime101.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime101.jsx)(Line, {}), (0, import_jsx_runtime101.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime101.jsx)(Text, { size: "sm", children: " Pay with " }), (0, import_jsx_runtime101.jsx)(Spacer, { y: "sm" }), props.children] })] });
}
function PaymentMethodSelection(props) {
  return (0, import_jsx_runtime101.jsx)(Container, { animate: "fadein", children: (0, import_jsx_runtime101.jsxs)(Container, { flex: "column", gap: "sm", children: [(0, import_jsx_runtime101.jsxs)(Button, { variant: "outline", bg: "tertiaryBg", onClick: () => {
    trackPayEvent({
    ...
    justifyContent: "flex-start",
    textAlign: "left"
  }, children: [(0, import_jsx_runtime101.jsx)(Container, { color: "secondaryText", flex: "row", center: "both", children: (0, import_jsx_runtime101.jsx)(IdCardIcon, { style: {
    width: iconSize.md,
    height: iconSize.md
  } }) }), (0, import_jsx_runtime101.jsxs)(Container, { flex: "column", gap: "xxs", children: [(0, import_jsx_runtime101.jsx)(Text, { size: "md", color: "primaryText", children: "Credit Card" }), (0, import_jsx_runtime101.jsx)(Text, { size: "xs", children: "Securely pay with credit card" })] })] }), (0, import_jsx_runtime101.jsxs)(Button, { variant: "outline", bg: "tertiaryBg", onClick: () => {
    trackPayEvent({
    ...
    justifyContent: "flex-start"
  }, gap: "sm", children: [(0, import_jsx_runtime101.jsx)(Container, { color: "secondaryText", flex: "row", center: "both", children: (0, import_jsx_runtime101.jsx)(CoinsIcon, { size: iconSize.md }) }), (0, import_jsx_runtime101.jsxs)(Container, { flex: "column", gap: "xxs", children: [(0, import_jsx_runtime101.jsx)(Text, { size: "md", color: "primaryText", children: "Crypto" }), (0, import_jsx_runtime101.jsx)(Text, { size: "xs", children: "Pay with your connected wallet" })] })] })] }) });
}
function SwapScreenContent(props) {
  ...
  const [drawerScreen, setDrawerScreen] = (0, import_react59.useState)("fees");
  ...
  return (0, import_jsx_runtime101.jsxs)(Container, { flex: "column", gap: "md", animate: "fadein", children: [isOpen && (0, import_jsx_runtime101.jsxs)(import_jsx_runtime101.Fragment, { children: [(0, import_jsx_runtime101.jsx)(DrawerOverlay, { ref: drawerOverlayRef }), (0, import_jsx_runtime101.jsx)(Drawer, { ref: drawerRef, close: () => setIsOpen(false), children: drawerScreen === "fees" && quoteQuery.data && (0, import_jsx_runtime101.jsxs)("div", { children: [(0, import_jsx_runtime101.jsx)(Text, { size: "lg", color: "primaryText", children: "Fees" }), (0, import_jsx_runtime101.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime101.jsx)(SwapFees, { quote: quoteQuery.data })] }) })] }), (0, import_jsx_runtime101.jsxs)("div", { children: [(0, import_jsx_runtime101.jsx)(WalletSelectorButton, { client: props.client, onClick: () => {
    setScreen({ id: "select-wallet" });
  }, address: props.payer.account.address, walletId: props.payer.wallet.id, containerStyle: {
    borderBottomRightRadius: 0,
    borderBottomLeftRadius: 0
  } }), (0, import_jsx_runtime101.jsx)(PayWithCrypto, { value: sourceTokenAmount || "", onSelectToken: showFromTokenSelector, chain: fromChain, token: fromToken, isLoading: quoteQuery.isLoading && !sourceTokenAmount, client, freezeChainAndTokenSelection: disableTokenSelection, payerAccount: props.payer.account, swapRequired }), swapRequired && (0, import_jsx_runtime101.jsx)(EstimatedTimeAndFees, { quoteIsLoading: quoteQuery.isLoading, estimatedSeconds: (_d = quoteQuery.data) == null ? void 0 : _d.swapDetails.estimated.durationSeconds, onViewFees: showFees }), (0, import_jsx_runtime101.jsx)(Spacer, { y: "md" })] }), errorMsg && (0, import_jsx_runtime101.jsxs)("div", { children: [errorMsg.minAmount && (0, import_jsx_runtime101.jsxs)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: ["Minimum amount is ", errorMsg.minAmount, " ", (0, import_jsx_runtime101.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true, color: "danger" })] }), (_e = errorMsg.msg) == null ? void 0 : _e.map((msg) => (0, import_jsx_runtime101.jsx)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: msg }, msg))] }), !errorMsg && isNotEnoughBalance && (0, import_jsx_runtime101.jsxs)("div", { children: [(0, import_jsx_runtime101.jsx)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: "Not enough funds." }), (0, import_jsx_runtime101.jsx)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: "Try a different wallet or token." })] }), (errorMsg == null ? void 0 : errorMsg.minAmount) ? (0, import_jsx_runtime101.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    props.setTokenAmount(String(errorMsg.minAmount));
    props.setHasEditedAmount(true);
  }, children: "Set Minimum" }) : switchChainRequired && !quoteQuery.isLoading && !isNotEnoughBalance && !quoteQuery.error ? (0, import_jsx_runtime101.jsx)(SwitchNetworkButton, { variant: "accent", fullWidth: true, switchChain: async () => {
    await props.payer.wallet.switchChain(fromChain);
  } }) : (0, import_jsx_runtime101.jsx)(Button, { variant: disableContinue ? "outline" : "accent", fullWidth: true, "data-disabled": disableContinue, disabled: disableContinue, onClick: async () => {
    if (!disableContinue) {
      showSwapFlow();
    }
  }, gap: "xs", children: quoteQuery.isLoading ? (0, import_jsx_runtime101.jsxs)(import_jsx_runtime101.Fragment, { children: ["Getting price quote", (0, import_jsx_runtime101.jsx)(Spinner, { size: "sm", color: "accentText" })] }) : "Continue" })] });
}
function FiatScreenContent(props) {
  ...
  return (0, import_jsx_runtime101.jsxs)(Container, { flex: "column", gap: "md", animate: "fadein", children: [isOpen && (0, import_jsx_runtime101.jsxs)(import_jsx_runtime101.Fragment, { children: [(0, import_jsx_runtime101.jsx)(DrawerOverlay, { ref: drawerOverlayRef }), (0, import_jsx_runtime101.jsx)(Drawer, { ref: drawerRef, close: () => setIsOpen(false), children: drawerScreen === "fees" && fiatQuoteQuery.data && (0, import_jsx_runtime101.jsxs)("div", { children: [(0, import_jsx_runtime101.jsx)(Text, { size: "lg", color: "primaryText", children: "Fees" }), (0, import_jsx_runtime101.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime101.jsx)(FiatFees, { quote: fiatQuoteQuery.data })] }) })] }), (0, import_jsx_runtime101.jsxs)("div", { children: [(0, import_jsx_runtime101.jsx)(PayWithCreditCard, { isLoading: fiatQuoteQuery.isLoading, value: (_c = fiatQuoteQuery.data) == null ? void 0 : _c.fromCurrencyWithFees.amount, client, currency: selectedCurrency, onSelectCurrency: showCurrencySelector }), (0, import_jsx_runtime101.jsx)(EstimatedTimeAndFees, { quoteIsLoading: fiatQuoteQuery.isLoading, estimatedSeconds: (_d = fiatQuoteQuery.data) == null ? void 0 : _d.estimatedDurationSeconds, onViewFees: showFees }), (0, import_jsx_runtime101.jsx)(Spacer, { y: "md" })] }), errorMsg && (0, import_jsx_runtime101.jsxs)("div", { children: [errorMsg.minAmount && (0, import_jsx_runtime101.jsxs)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: ["Minimum amount is ", errorMsg.minAmount, " ", (0, import_jsx_runtime101.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true, color: "danger" })] }), (_e = errorMsg.msg) == null ? void 0 : _e.map((msg) => (0, import_jsx_runtime101.jsx)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: msg }, msg))] }), (errorMsg == null ? void 0 : errorMsg.minAmount) ? (0, import_jsx_runtime101.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    props.setTokenAmount(String(errorMsg.minAmount));
    props.setHasEditedAmount(true);
  }, children: "Set Minimum" }) : (0, import_jsx_runtime101.jsx)(Button, { variant: disableSubmit ? "outline" : "accent", "data-disabled": disableSubmit, disabled: disableSubmit, fullWidth: true, onClick: handleSubmit, gap: "xs", children: fiatQuoteQuery.isLoading ? (0, import_jsx_runtime101.jsxs)(import_jsx_runtime101.Fragment, { children: ["Getting price quote", (0, import_jsx_runtime101.jsx)(Spinner, { size: "sm", color: "accentText" })] }) : "Continue" })] });
}
...
function ChainSelectionScreen(props) {
  return (0, import_jsx_runtime101.jsx)(NetworkSelectorContent, { client: props.client, connectLocale: props.connectLocale, showTabs: false, onBack: props.goBack, chains: props.chains, closeModal: props.goBack, networkSelector: {
    renderChain(renderChainProps) {
      return (0, import_jsx_runtime101.jsx)(ChainButton, { chain: renderChainProps.chain, confirming: false, switchingFailed: false, onClick: () => {
...
//# sourceMappingURL=chunk-LBYJMS5U.js.map
