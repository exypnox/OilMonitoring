...
const EmailIcon_js_1 = require("../../ui/ConnectWallet/icons/EmailIcon.js");
const FingerPrintIcon_js_1 = require("../../ui/ConnectWallet/icons/FingerPrintIcon.js");
const GuestIcon_js_1 = require("../../ui/ConnectWallet/icons/GuestIcon.js");
const OutlineWalletIcon_js_1 = require("../../ui/ConnectWallet/icons/OutlineWalletIcon.js");
const PhoneIcon_js_1 = require("../../ui/ConnectWallet/icons/PhoneIcon.js");
...
const ConnectWalletSocialOptions = (props) => {
    ...
    const { data: ecosystemAuthOptions, isLoading } = (0, react_query_1.useQuery)({
        ...
        queryFn: async () => {
            if ((0, is_ecosystem_wallet_js_1.isEcosystemWallet)(wallet)) {
                const options = await (0, get_ecosystem_wallet_auth_options_js_1.getEcosystemInfo)(wallet.id);
        ...
        try {
            ...
            const connectPromise = (() => {
                if (props.isLinking) {
                    ...
                    return (0, index_js_1.linkProfile)(connectOptions);
                }
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "md", style: {
            position: "relative",
                        ...
                        const imgIconSize = (() => {
                            if (!showOnlyIcons) {
                                return index_js_2.iconSize.md;
                            }
                            if (socialLogins.length > 4) {
                                return index_js_2.iconSize.md;
                            }
                            return index_js_2.iconSize.lg;
                        })();
                ...
                (inputMode === "email" ? ((0, jsx_runtime_1.jsx)(InputSelectionUI_js_1.InputSelectionUI, { type: type, onSelect: (value) => {
                        ...
                        return undefined;
                    }, disabled: props.disabled, emptyErrorMessage: emptyErrorMessage, submitButtonText: locale.submitEmail })) : ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, icon: EmailIcon_js_1.EmailIcon, onClick: () => {
                ...
                (inputMode === "phone" ? ((0, jsx_runtime_1.jsx)(InputSelectionUI_js_1.InputSelectionUI, { format: "phone", type: type, onSelect: (value) => {
                        ...
                        return undefined;
                    }, disabled: props.disabled, emptyErrorMessage: emptyErrorMessage, submitButtonText: locale.submitEmail })) : ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, icon: PhoneIcon_js_1.PhoneIcon, onClick: () => {
                        setManualInputMode("phone");
                    }, title: locale.phonePlaceholder, disabled: props.disabled }))), passKeyEnabled && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, icon: FingerPrintIcon_js_1.FingerPrintIcon, onClick: () => {
                    handlePassKeyLogin();
                }, title: locale.passkey, disabled: props.disabled })), siweEnabled && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, icon: OutlineWalletIcon_js_1.OutlineWalletIcon, onClick: () => {
                    handleWalletLogin();
                }, title: locale.signInWithWallet })), guestEnabled && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, icon: GuestIcon_js_1.GuestIcon, onClick: () => {
                    handleGuestLogin();
                }, title: locale.loginAsGuest, disabled: props.disabled })), props.isLinking && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, icon: OutlineWalletIcon_js_1.OutlineWalletIcon, onClick: () => {
                    handleWalletLogin();
...
const SocialButton = /* @__PURE__ */ (0, styled_1.default)(buttons_js_1.Button)({
    "&[data-variant='full']": {
        ...
        padding: index_js_2.spacing.md,
        gap: index_js_2.spacing.sm,
