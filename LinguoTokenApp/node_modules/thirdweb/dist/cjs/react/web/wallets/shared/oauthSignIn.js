...
exports.openOauthSignInWindow = openOauthSignInWindow;
const getLoginPath_js_1 = require("../../../../wallets/in-app/core/authentication/getLoginPath.js");
...
function getOauthLoginPath(authOption, client, ecosystem) {
    switch (authOption) {
        ...
        case "coinbase":
        case "discord":
            return (0, getLoginPath_js_1.getLoginUrl)({ authOption, client, ecosystem });
        default:
...
`;
//# sourceMappingURL=oauthSignIn.js.map