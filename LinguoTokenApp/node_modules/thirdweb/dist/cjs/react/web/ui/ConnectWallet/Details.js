...
const ConnectedWalletDetails = (props) => {
    ...
    const { pfp, name, balanceQuery } = (0, wallet_js_1.useConnectedWalletDetails)(client, walletChain, activeAccount, props.detailsButton?.displayBalanceToken);
    function closeModal() {
        setRootEl(null);
    }
    function openModal() {
    ...
    return ((0, jsx_runtime_1.jsxs)(WalletInfoButton, { type: "button", className: combinedClassName, style: props.detailsButton?.style, "data-test": "connected-wallet-details", onClick: openModal, children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { style: {
                    ...
                    width: "35px",
                    height: "35px",
                }, children: avatarSrc ? ((0, jsx_runtime_1.jsx)("img", { alt: "", src: avatarSrc, style: {
                        width: "100%",
                        height: "100%",
                    } })) : (activeAccount && (0, jsx_runtime_1.jsx)(Blobbie_js_1.Blobbie, { address: activeAccount.address, size: 35 })) }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "4xs", style: {
                    textOverflow: "ellipsis",
                    whiteSpace: "nowrap",
                    borderRadius: `0 ${index_js_1.radius.md} ${index_js_1.radius.md} 0`,
                }, children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "xs", color: "primaryText", weight: 500, className: `${TW_CONNECTED_WALLET}__address`, children: props.detailsButton?.connectedAccountName ?? name }), balanceQuery.data ? ((0, jsx_runtime_1.jsxs)(text_js_1.Text, { className: `${TW_CONNECTED_WALLET}__balance`, size: "xs", color: "secondaryText", weight: 400, children: [formatBalanceOnButton(Number(balanceQuery.data.displayValue)), " ", balanceQuery.data.symbol] })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: index_js_1.fontSize.xs, width: "70px" }))] })] }));
};
...
function DetailsModal(props) {
    ...
    const walletChain = (0, useActiveWalletChain_js_1.useActiveWalletChain)();
    const activeAccount = (0, useActiveAccount_js_1.useActiveAccount)();
    const { pfp, name, balanceQuery } = (0, wallet_js_1.useConnectedWalletDetails)(client, walletChain, activeAccount, props.displayBalanceToken);
    const theme = (0, CustomThemeProvider_js_1.parseTheme)(props.theme);
    const activeWallet = (0, useActiveWallet_js_1.useActiveWallet)();
    const chainIconQuery = (0, useChainQuery_js_1.useChainIconUrl)(walletChain);
    const chainNameQuery = (0, useChainQuery_js_1.useChainName)(walletChain);
    ...
    const networkSwitcherButton = ((0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuButton, { type: "button", disabled: disableSwitchChain, onClick: () => {
            setScreen("network-switcher");
        }, "data-variant": "primary", children: [(0, jsx_runtime_1.jsx)("div", { style: {
                    display: "flex",
                    alignItems: "center",
                    position: "relative",
                }, children: !chainIconQuery.isLoading ? ((0, jsx_runtime_1.jsx)(ChainIcon_js_1.ChainIcon, { chainIconUrl: chainIconQuery.url, size: index_js_1.iconSize.md, active: true, client: client })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: `${index_js_1.iconSize.md}px`, width: `${index_js_1.iconSize.md}px` })) }), chainNameQuery.isLoading ? ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "16px", width: "150px" })) : ((0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", size: "md", multiline: true, children: [chainNameQuery.name || `Unknown chain #${walletChain?.id}`, (0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "secondaryText", size: "xs", children: [balanceQuery.data ? ((0, formatNumber_js_1.formatNumber)(Number(balanceQuery.data.displayValue), 9)) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "1em", width: "100px" })), " ", balanceQuery.data?.symbol] })] })), (0, jsx_runtime_1.jsx)(StyledChevronRightIcon, { width: index_js_1.iconSize.sm, height: index_js_1.iconSize.sm, style: {
                    flexShrink: 0,
                    marginLeft: "auto",
                } })] }));
    ...
    const avatarContent = ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { style: {
            ...
            width: `${index_js_1.iconSize.xl}px`,
                    ...
                    borderRadius: "100%",
                    overflow: "hidden",
                }, children: avatarSrc ? ((0, jsx_runtime_1.jsx)("img", { src: avatarSrc, style: {
                        width: index_js_1.iconSize.xxl,
                        height: index_js_1.iconSize.xxl,
                    }, alt: "" })) : (activeAccount && ((0, jsx_runtime_1.jsx)(Blobbie_js_1.Blobbie, { address: activeAccount.address, size: Number(index_js_1.iconSize.xxl) }))) }), !props.detailsModal?.hideSwitchWallet ? ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { style: {
                    position: "absolute",
                    bottom: -2,
                    right: -2,
    ...
    let content = ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xs" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "lg", gap: "sm", flex: "row", center: "y", style: {
                    ...
                    paddingBottom: hideAllButtons ? index_js_1.spacing.md : index_js_1.spacing.lg,
                            ...
                            gap: "1px",
                        }, children: [networkSwitcherButton, (0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuButton, { onClick: () => {
                                    setScreen("transactions");
                                }, style: {
                                    fontSize: index_js_1.fontSize.sm,
                                }, children: [(0, jsx_runtime_1.jsx)(react_icons_1.TextAlignJustifyIcon, { width: index_js_1.iconSize.md, height: index_js_1.iconSize.md }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", gap: "xs", center: "y", children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: locale.transactions }) })] }), (props.assetTabs === undefined || props.assetTabs.length) && ((0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuButton, { onClick: () => {
                                    setScreen("view-assets");
                                }, style: {
                                    fontSize: index_js_1.fontSize.sm,
                                }, children: [(0, jsx_runtime_1.jsx)(CoinsIcon_js_1.CoinsIcon, { size: index_js_1.iconSize.md }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: props.supportedNFTs
                                            ? locale.viewFunds.viewAssets
                                            : locale.viewFunds.title })] })), (0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuButton, { onClick: () => {
...
function InAppWalletUserInfo(props) {
    ...
    return (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { width: "50px", height: "10px" });
}
/**
 * @internal
 */
