...
export declare const socialAuthOptions: readonly ["google", "apple", "facebook", "discord", "line", "x", "coinbase", "farcaster", "telegram", "github", "twitch"];
export type SocialAuthOption = (typeof socialAuthOptions)[number];
export type OAuthOption = SocialAuthOption | "guest";
export declare const authOptions: readonly ["google", "apple", "facebook", "discord", "line", "x", "coinbase", "farcaster", "telegram", "github", "twitch", "guest", "email", "phone", "passkey", "wallet"];
