...
import { useConnectedWalletDetails, useWalletInfo, } from "../../../core/utils/wallet.js";
...
export const ConnectedWalletDetails = (props) => {
    ...
    const { pfp, name, balanceQuery } = useConnectedWalletDetails(client, walletChain, activeAccount, props.detailsButton?.displayBalanceToken);
    function closeModal() {
        setRootEl(null);
    }
    function openModal() {
    ...
    return (_jsxs(WalletInfoButton, { type: "button", className: combinedClassName, style: props.detailsButton?.style, "data-test": "connected-wallet-details", onClick: openModal, children: [_jsx(Container, { style: {
                    ...
                    width: "35px",
                    height: "35px",
                }, children: avatarSrc ? (_jsx("img", { alt: "", src: avatarSrc, style: {
                        width: "100%",
                        height: "100%",
                    } })) : (activeAccount && _jsx(Blobbie, { address: activeAccount.address, size: 35 })) }), _jsxs(Container, { flex: "column", gap: "4xs", style: {
                    textOverflow: "ellipsis",
                    whiteSpace: "nowrap",
                    borderRadius: `0 ${radius.md} ${radius.md} 0`,
                }, children: [_jsx(Text, { size: "xs", color: "primaryText", weight: 500, className: `${TW_CONNECTED_WALLET}__address`, children: props.detailsButton?.connectedAccountName ?? name }), balanceQuery.data ? (_jsxs(Text, { className: `${TW_CONNECTED_WALLET}__balance`, size: "xs", color: "secondaryText", weight: 400, children: [formatBalanceOnButton(Number(balanceQuery.data.displayValue)), " ", balanceQuery.data.symbol] })) : (_jsx(Skeleton, { height: fontSize.xs, width: "70px" }))] })] }));
};
function DetailsModal(props) {
    ...
    const avatarContent = (_jsxs(Container, { style: {
            ...
            width: `${iconSize.xl}px`,
                    ...
                    borderRadius: "100%",
                    overflow: "hidden",
                }, children: avatarSrc ? (_jsx("img", { src: avatarSrc, style: {
                        width: iconSize.xxl,
                        height: iconSize.xxl,
                    }, alt: "" })) : (activeAccount && (_jsx(Blobbie, { address: activeAccount.address, size: Number(iconSize.xxl) }))) }), !props.detailsModal?.hideSwitchWallet ? (_jsx(Container, { style: {
                    position: "absolute",
                    bottom: -2,
                    right: -2,
    ...
    let content = (_jsxs("div", { children: [_jsx(Spacer, { y: "xs" }), _jsxs(Container, { px: "lg", gap: "sm", flex: "row", center: "y", style: {
                    ...
                    paddingBottom: hideAllButtons ? spacing.md : spacing.lg,
                                ...
                                setScreen("wallet-manager");
                                    ...
                                    gap: spacing.xxs,
                                    alignItems: "center",
                                }, children: [_jsx(Text, { color: "primaryText", weight: 500, size: "md", children: props.detailsModal?.connectedAccountName ?? name }), _jsx(IconButton, { children: _jsx(CopyIcon, { text: activeAccount?.address || "", tip: locale.copyAddress }) })] }), _jsx(InAppWalletUserInfo, { client: client, locale: locale })] })] }), !hideAllButtons && (_jsxs(_Fragment, { children: [_jsx(Container, { px: "lg", children: _jsxs(Container, { style: {
                                display: "flex",
                                gap: spacing.xs,
                            ...
                            gap: "1px",
                                    ...
                                    fontSize: fontSize.sm,
                                }, children: [_jsx(TextAlignJustifyIcon, { width: iconSize.md, height: iconSize.md }), _jsx(Container, { flex: "row", gap: "xs", center: "y", children: _jsx(Text, { color: "primaryText", children: locale.transactions }) })] }), (props.assetTabs === undefined || props.assetTabs.length) && (_jsxs(MenuButton, { onClick: () => {
                                    setScreen("view-assets");
                                }, style: {
                                    fontSize: fontSize.sm,
                                }, children: [_jsx(CoinsIcon, { size: iconSize.md }), _jsx(Text, { color: "primaryText", children: props.supportedNFTs
                                            ? locale.viewFunds.viewAssets
                                            : locale.viewFunds.title })] })), _jsxs(MenuButton, { onClick: () => {
...
function InAppWalletUserInfo(props) {
    ...
    return _jsx(Skeleton, { width: "50px", height: "10px" });
}
/**
 * @internal
 */
