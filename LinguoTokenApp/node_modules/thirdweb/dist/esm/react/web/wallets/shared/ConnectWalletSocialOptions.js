    ...
    return (_jsxs(Container, { flex: "column", gap: "md", style: {
            position: "relative",
                ...
                (inputMode === "phone" ? (_jsx(InputSelectionUI, { format: "phone", type: type, onSelect: (value) => {
                    ...
                    }, title: locale.phonePlaceholder, disabled: props.disabled }))), passKeyEnabled && (_jsx(WalletTypeRowButton, { client: props.client, icon: FingerPrintIcon, onClick: () => {
                    handlePassKeyLogin();
                }, title: locale.passkey, disabled: props.disabled })), siweEnabled && (_jsx(WalletTypeRowButton, { client: props.client, icon: OutlineWalletIcon, onClick: () => {
                    handleWalletLogin();
                }, title: locale.signInWithWallet })), guestEnabled && (_jsx(WalletTypeRowButton, { client: props.client, icon: GuestIcon, onClick: () => {
                    handleGuestLogin();
                }, title: locale.loginAsGuest, disabled: props.disabled })), props.isLinking && (_jsx(WalletTypeRowButton, { client: props.client, icon: OutlineWalletIcon, onClick: () => {
                    handleWalletLogin();
