...
import { APPLE_ICON, DISCORD_ICON, EMAIL_ICON, FACEBOOK_ICON, FARCASTER_ICON, GITHUB_ICON, GOOGLE_ICON, GUEST_ICON, LINE_ICON, PASSKEY_ICON, PHONE_ICON, TELEGRAM_ICON, TWITCH_ICON, WALLET_ICON, X_ICON, } from "../icons/svgs.js";
...
export const WalletImage = (props) => {
    ...
    return (_jsx(RNImage, { theme: props.theme, data: data, size: size, color: props.theme.colors.accentButtonBg }));
};
export function getAuthProviderImage(authProvider) {
    switch (authProvider) {
        case "phone":
            return PHONE_ICON;
        case "email":
